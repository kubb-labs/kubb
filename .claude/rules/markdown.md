...
`humanizer` skill is the full reference. For the complete writing guide (voice, content
patterns, SEO) use the `documentation` skill. This rule adds only the markdown-structure
specifics:
