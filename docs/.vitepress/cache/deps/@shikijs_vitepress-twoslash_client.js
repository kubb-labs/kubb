...
var arrow = (options) => ({
  ...
  options,
  async fn(state) {
    const { x: x2, y: y2, placement, rects, platform: platform2, elements, middlewareData } = state
...
var autoPlacement = function (options) {
  ...
  return {
    ...
    async fn(state) {
      ...
      const placements$1 =
        alignment !== void 0 || allowedPlacements === placements ? getPlacementList(alignment || null, autoAlignment, allowedPlacements) : allowedPlacements
      ...
      const placementsSortedByMostSpace = allOverflows
        ...
        .sort((a, b2) => a[1] - b2[1])
      const placementsThatFitOnEachSide = placementsSortedByMostSpace.filter((d2) =>
        d2[2]
          .slice(
            0,
      ...
      const resetPlacement =
        ((_placementsThatFitOnE = placementsThatFitOnEachSide[0]) == null ? void 0 : _placementsThatFitOnE[0]) || placementsSortedByMostSpace[0][0]
  ...
  return {
    ...
    async fn(state) {
      ...
      if (!overflows.every((side2) => side2 <= 0)) {
        ...
        let resetPlacement =
          (_overflowsData$filter = overflowsData.filter((d2) => d2.overflows[0] <= 0).sort((a, b2) => a.overflows[1] - b2.overflows[1])[0]) == null
            ? void 0
            ...
            case 'bestFit': {
              ...
              const placement2 =
                (_overflowsData$filter2 = overflowsData
                  ...
                  .map((d2) => [d2.placement, d2.overflows.filter((overflow2) => overflow2 > 0).reduce((acc, overflow2) => acc + overflow2, 0)])
...
function getBoundingClientRect(element, includeScale, isFixedStrategy, offsetParent) {
  ...
  let x2 =
    (clientRect.left + (addVisualOffsets ? ((_win$visualViewport = win.visualViewport) == null ? void 0 : _win$visualViewport.offsetLeft) || 0 : 0)) / scale.x
  let y2 =
    (clientRect.top + (addVisualOffsets ? ((_win$visualViewport2 = win.visualViewport) == null ? void 0 : _win$visualViewport2.offsetTop) || 0 : 0)) / scale.y
...
function getOffsetParent(element) {
  ...
  if (
    ...
    (getNodeName(offsetParent) === 'html' ||
      (getNodeName(offsetParent) === 'body' && getComputedStyle$1(offsetParent).position === 'static' && !isContainingBlock(offsetParent)))
  ) {
    return window2
  }
...
// ../node_modules/.pnpm/floating-vue@5.2.2_@nuxt+kit@3.16.2_magicast@0.3.5__vue@3.5.13_typescript@5.8.3_/node_modules/floating-vue/dist/floating-vue.mjs
function ye(e, t) {
...
function S(e, t) {
  let o = h2.themes[e] || {},
    i
  do (i = o[t]), typeof i > 'u' ? (o.$extend ? (o = h2.themes[o.$extend] || {}) : ((o = null), (i = h2[t]))) : (o = null)
  while (o)
  return i
}
function Ze(e) {
  const t = [e]
  let o = h2.themes[e] || {}
  do o.$extend && !o.$resetCss ? (t.push(o.$extend), (o = h2.themes[o.$extend] || {})) : (o = null)
  while (o)
...
function re(e) {
  const t = [e]
  let o = h2.themes[e] || {}
  do o.$extend ? (t.push(o.$extend), (o = h2.themes[o.$extend] || {})) : (o = null)
  while (o)
  return t
}
var $ = false
...
var Te = ['auto', 'top', 'bottom', 'left', 'right'].reduce((e, t) => e.concat([t, `${t}-start`, `${t}-end`]), [])
var pe = {
  hover: 'mouseenter',
  focus: 'focus',
  click: 'click',
    ...
    methods: {
      show({ event: e = null, skipDelay: t = false, force: o = false } = {}) {
        ...
        ;((i = this.parentPopper) != null && i.lockedChild && this.parentPopper.lockedChild !== this) ||
          ...
          (o || !this.disabled) &&
            (((s = this.parentPopper) == null ? void 0 : s.lockedChild) === this && (this.parentPopper.lockedChild = null),
      ...
      hide({ event: e = null, skipDelay: t = false } = {}) {
        ...
        if (!this.$_hideInProgress) {
          ...
          ;((o = this.parentPopper) == null ? void 0 : o.lockedChild) === this && (this.parentPopper.lockedChild = null),
            (this.pendingHide = false),
        ...
        if (
          ...
          this.arrowOverflow &&
            e.middleware.push({
              ...
              fn: ({ placement: i, rects: s, middlewareData: r }) => {
                ...
                return (
                  i.startsWith('top') || i.startsWith('bottom') ? (p = Math.abs(a) > s.reference.width / 2) : (p = Math.abs(a) > s.reference.height / 2),
                  {
                    data: {
                      overflow: p,
                    },
          ...
          e.middleware.push({
            ...
            fn: ({ rects: s, placement: r, middlewareData: p }) => {
              ...
              let a, l
              return (
                r.startsWith('top') || r.startsWith('bottom') ? (a = s.reference.width) : (l = s.reference.height),
                (this.$_innerNode.style[i === 'min' ? 'minWidth' : i === 'max' ? 'maxWidth' : 'width'] = a != null ? `${a}px` : null),
                (this.$_innerNode.style[i === 'min' ? 'minHeight' : i === 'max' ? 'maxHeight' : 'height'] = l != null ? `${l}px` : null),
                {
                  data: {
                    skip: true,
                  },
        ...
        clearTimeout(this.$_disposeTimer),
          ...
          !this.isShown &&
            ...
            this.positioningDisabled ||
              this.$_registerEventListeners([...getOverflowAncestors(this.$_referenceNode), ...getOverflowAncestors(this.$_popperNode)], 'scroll', () => {
      ...
      async $_applyShowEffect() {
        ...
        if (this.computeTransformOrigin) {
          const t = this.$_referenceNode.getBoundingClientRect(),
            ...
            s = t.x + t.width / 2 - (i.left + o.offsetLeft),
            r = t.y + t.height / 2 - (i.top + o.offsetTop)
      ...
      $_addEventListeners() {
        ...
        this.$_registerTriggerListeners(this.$_targetNodes, pe, this.triggers, this.showTriggers, e),
          this.$_registerTriggerListeners([this.$_popperNode], pe, this.popperTriggers, this.popperShowTriggers, e)
        const t = (o) => {
          o.usedByTooltip || this.hide({ event: o })
        }
        this.$_registerTriggerListeners(this.$_targetNodes, ae, this.triggers, this.hideTriggers, t),
          this.$_registerTriggerListeners([this.$_popperNode], ae, this.popperTriggers, this.popperHideTriggers, t)
      },
      ...
      $_registerTriggerListeners(e, t, o, i, s) {
        let r = o
        i != null && (r = typeof i == 'function' ? i(r) : i),
          r.forEach((p) => {
            const a = t[p]
      ...
      $_isAimingPopper() {
        ...
        if (y >= e.left && y <= e.right && _ >= e.top && _ <= e.bottom) {
          const t = this.$_popperNode.getBoundingClientRect(),
            ...
            a = m + i * r
          return (
            C(c, m, p, a, t.left, t.top, t.left, t.bottom) || // Left edge
...
if (typeof document < 'u' && typeof window < 'u') {
  ...
  } else window.addEventListener('mousedown', (e) => ue(e, false), true), window.addEventListener('click', (e) => fe(e, false), true)
  window.addEventListener('resize', tt)
}
function ue(e, t) {
  if (h2.autoHideOnMousedown) Pe(e, t)
  else
...
function C(e, t, o, i, s, r, p, a) {
  const l = ((p - s) * (t - r) - (a - r) * (e - s)) / ((a - r) * (o - e) - (p - s) * (i - t)),
  ...
  methods: {
    ...
    removeResizeHandlers() {
      this._resizeObject &&
        ...
        (!z && this._resizeObject.contentDocument && this._resizeObject.contentDocument.defaultView.removeEventListener('resize', this.compareAndNotify),
...
function wt(e, t, o, i, s, r) {
  const p = resolveComponent('PopperContent'),
        ...
        default: withCtx(
          ({
            ...
            createVNode(
              ...
              1032,
              ['popper-id', 'theme', 'shown', 'mounted', 'skip-transition', 'auto-hide', 'handle-resize', 'classes', 'result', 'onHide', 'onResize'],
            ),
          ],
        ),
        _: 3,
        ...
        default: withCtx(
          ({
            ...
            createVNode(
              ...
              1032,
              ['class', 'popper-id', 'theme', 'shown', 'mounted', 'skip-transition', 'auto-hide', 'handle-resize', 'classes', 'result', 'onHide', 'onResize'],
            ),
          ],
        ),
        _: 1,
...
function Ne(e, t, o) {
  ...
  const s = typeof t
  return (
    s === 'string' ? (i = { content: t }) : t && s === 'object' ? (i = t) : (i = { content: false }),
    (i.placement = Tt(i, o)),
    (i.targetNodes = () => [e]),
    (i.referenceNode = () => e),
    i
...
function me(e, { value: t, modifiers: o }) {
  ...
  if (!i.content || S(i.theme || 'tooltip', 'disabled')) He(e)
    ...
    let s
    e.$_popper ? ((s = e.$_popper), (s.options.value = i)) : (s = bt(e, t, o)),
      typeof t.shown < 'u' && t.shown !== e.$_popperOldShown && ((e.$_popperOldShown = t.shown), t.shown ? s.show() : s.hide())
  }
}
var oe = {
  beforeMount: me,
...
function Ct(e, t = {}) {
  e.$_vTooltipInstalled ||
    ((e.$_vTooltipInstalled = true),
    ye(h2, t),
    e.directive('tooltip', oe),
    e.directive('close-popper', ie),
    e.component('VTooltip', Ce),
    e.component('VDropdown', Se),
    e.component('VMenu', be))
}
var Gt = {
...
// ../node_modules/.pnpm/@shikijs+vitepress-twoslash@3.2.2_@nuxt+kit@3.16.2_magicast@0.3.5__typescript@5.8.3/node_modules/@shikijs/vitepress-twoslash/dist/client.mjs
        ...
        (e) => {
          ...
          if (
            path.some((el) => {
              var _a, _b, _c, _d
              return (
                ((_b = (_a = el == null ? void 0 : el.classList) == null ? void 0 : _a.contains) == null ? void 0 : _b.call(_a, 'vp-code-group')) ||
                ((_d = (_c = el == null ? void 0 : el.classList) == null ? void 0 : _c.contains) == null ? void 0 : _d.call(_c, 'tabs'))
              )
            })
          )
            tt()
