[API](../../../../../packages.md) / [@kubb/parser-ts](../../../index.md) / [ts](../index.md) / ClassLikeDeclarationBase
...
```ts
readonly kind: ClassExpression | ClassDeclaration;
```
...
node\_modules/.pnpm/typescript@5.6.2/node\_modules/typescript/lib/typescript.d.ts:5348
