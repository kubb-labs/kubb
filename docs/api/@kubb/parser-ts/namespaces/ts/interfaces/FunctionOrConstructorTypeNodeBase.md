[API](../../../../../packages.md) / [@kubb/parser-ts](../../../index.md) / [ts](../index.md) / FunctionOrConstructorTypeNodeBase
...
```ts
readonly kind: FunctionType | ConstructorType;
```
...
node\_modules/.pnpm/typescript@5.6.2/node\_modules/typescript/lib/typescript.d.ts:4671
