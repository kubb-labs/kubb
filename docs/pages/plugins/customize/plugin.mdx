...
The easiest way to get started is to use our [template on Github](https://github.com/kubb-project/kubb-plugin-template) or clone the following repo [https://github.com/kubb-project/kubb-plugin-template](https://github.com/kubb-project/kubb-plugin-template).
