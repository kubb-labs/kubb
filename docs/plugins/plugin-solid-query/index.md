...
```typescript
import { pluginReactQuery } from '@kubb/plugin-solid-query'
...
import type { Mutation, Query, QueryOptions, QueryKey, QueryImports } from '@kubb/plugin-solid-query/components'
...
```tsx
import { pluginReactQuery } from '@kubb/plugin-solid-query'
import { Query } from '@kubb/plugin-solid-query/components'
