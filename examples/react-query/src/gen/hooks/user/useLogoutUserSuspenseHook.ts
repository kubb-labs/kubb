...
import type { LogoutUserResponseData3 } from '../../models/LogoutUser.ts'
 ...
 * {@link /user/logout}
 */
export function useLogoutUserSuspenseHook<TData = LogoutUserResponseData3, TQueryKey extends QueryKey = LogoutUserSuspenseQueryKey>(
  options: {
