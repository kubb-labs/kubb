 ...
 * {@link /user/:username}
 */
async function updateUserHook({ username }: {
    username: UpdateUserPathParams["username"];
}, data?: UpdateUserMutationRequest, config: Partial<RequestConfig<UpdateUserMutationRequest>> = {}) {
 ...
 * {@link /user/:username}
 */
export function useUpdateUserHook(options: {
