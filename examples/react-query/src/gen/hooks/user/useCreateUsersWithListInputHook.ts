 ...
 */
async function createUsersWithListInputHook(data?: CreateUsersWithListInputMutationRequest, config: Partial<RequestConfig<CreateUsersWithListInputMutationRequest>> = {}) {
    const res = await client<CreateUsersWithListInputMutationResponse, Error, CreateUsersWithListInputMutationRequest>({ method: "POST", url: `/user/createWithList`, data, ...config });
    return res.data;
}
