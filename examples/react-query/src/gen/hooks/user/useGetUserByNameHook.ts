...
import { queryOptions, useQuery } from "@tanstack/react-query";
 ...
 export const getUserByNameQueryKey = ({ username }: {
...
async function getUserByNameHook({ username }: {
 ...
 export function getUserByNameQueryOptionsHook({ username }: {
    username: GetUserByNamePathParams["username"];
}, config: Partial<RequestConfig> = {}) {
 ...
 * {@link /user/:username}
 */
export function useGetUserByNameHook<TData = GetUserByNameQueryResponse, TQueryData = GetUserByNameQueryResponse, TQueryKey extends QueryKey = GetUserByNameQueryKey>({ username }: {
    username: GetUserByNamePathParams["username"];
}, options: {
