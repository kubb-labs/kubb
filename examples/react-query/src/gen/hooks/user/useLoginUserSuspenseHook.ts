 ...
 * {@link /user/login}
 */
export function useLoginUserSuspenseHook<TData = LoginUserQueryResponse, TQueryData = LoginUserQueryResponse, TQueryKey extends QueryKey = LoginUserSuspenseQueryKey>(params?: LoginUserQueryParams, options: 
  {
