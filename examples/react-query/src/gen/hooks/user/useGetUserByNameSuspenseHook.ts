 ...
 * {@link /user/:username}
 */
export async function getUserByNameSuspenseHook({ username }: { username: GetUserByNamePathParams["username"] }, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
 ...
 * {@link /user/:username}
 */
export function useGetUserByNameSuspenseHook<TData = GetUserByNameQueryResponse, TQueryData = GetUserByNameQueryResponse, TQueryKey extends QueryKey = GetUserByNameSuspenseQueryKey>({ username }: { username: GetUserByNamePathParams["username"] }, options: 
  {
