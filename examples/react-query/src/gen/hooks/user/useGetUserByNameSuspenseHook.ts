...
import { queryOptions, useSuspenseQuery } from "@tanstack/react-query";
 ...
 export const getUserByNameSuspenseQueryKey = ({ username }: {
 ...
 * {@link /user/:username}
 */
async function getUserByNameHook({ username }: {
    username: GetUserByNamePathParams["username"];
 ...
 export function getUserByNameSuspenseQueryOptionsHook({ username }: {
    username: GetUserByNamePathParams["username"];
}, config: Partial<RequestConfig> = {}) {
 ...
 * {@link /user/:username}
 */
export function useGetUserByNameSuspenseHook<TData = GetUserByNameQueryResponse, TQueryData = GetUserByNameQueryResponse, TQueryKey extends QueryKey = GetUserByNameSuspenseQueryKey>({ username }: {
    username: GetUserByNamePathParams["username"];
}, options: {
