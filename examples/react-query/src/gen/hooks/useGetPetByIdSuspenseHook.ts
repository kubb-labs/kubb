...
import { useSuspenseQuery, queryOptions } from "@tanstack/react-query";
 ...
 export const getPetByIdSuspenseQueryKey = ({ petId }: {
...
async function getPetById({ petId }: {
 ...
 export function getPetByIdSuspenseQueryOptions({ petId }: {
    petId: GetPetByIdPathParams["petId"];
}, config: Partial<RequestConfig> = {}) {
 ...
 * @link /pet/:petId
 */
export function useGetPetByIdSuspenseHook<TData = GetPetByIdQueryResponse, TQueryData = GetPetByIdQueryResponse, TQueryKey extends QueryKey = GetPetByIdSuspenseQueryKey>({ petId }: {
    petId: GetPetByIdPathParams["petId"];
}, options: {
