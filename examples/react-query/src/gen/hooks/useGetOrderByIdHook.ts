...
export function getOrderByIdInfiniteQueryOptions<TData = GetOrderById["response"], TQueryData = GetOrderById["response"]>(orderId: GetOrderByIdPathParams["orderId"], options: GetOrderById["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<GetOrderById["response"], GetOrderById["error"], TData, TQueryData>, "queryKey"> {
