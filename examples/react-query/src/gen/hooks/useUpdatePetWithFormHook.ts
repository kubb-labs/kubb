...
import { useQuery, queryOptions, useSuspenseQuery } from "@tanstack/react-query";
 ...
 export const updatePetWithFormQueryKey = (petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"]) => [{ url: "/pet/:petId", params: { petId: petId } }, ...(params ? [params] : [])] as const;

 export type UpdatePetWithFormQueryKey = ReturnType<typeof updatePetWithFormQueryKey>;

 export function updatePetWithFormQueryOptions(petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"], options: UpdatePetWithForm["client"]["parameters"] = {}) {
 ...
 * @link /pet/:petId
 */
export function useUpdatePetWithFormHook<TData = UpdatePetWithForm["response"], TQueryData = UpdatePetWithForm["response"], TQueryKey extends QueryKey = UpdatePetWithFormQueryKey>(petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"], options: {
 ...
 export const updatePetWithFormSuspenseQueryKey = (petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"]) => [{ url: "/pet/:petId", params: { petId: petId } }, ...(params ? [params] : [])] as const;

 export type UpdatePetWithFormSuspenseQueryKey = ReturnType<typeof updatePetWithFormSuspenseQueryKey>;

 export function updatePetWithFormSuspenseQueryOptions(petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"], options: UpdatePetWithForm["client"]["parameters"] = {}) {
 ...
 * @link /pet/:petId
 */
export function useUpdatePetWithFormHookSuspense<TData = UpdatePetWithForm["response"], TQueryKey extends QueryKey = UpdatePetWithFormSuspenseQueryKey>(petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"], options: {
