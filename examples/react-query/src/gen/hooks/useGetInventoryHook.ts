...
export function getInventoryInfiniteQueryOptions<TData = GetInventory["response"], TQueryData = GetInventory["response"]>(options: GetInventory["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<GetInventory["response"], GetInventory["error"], TData, TQueryData>, "queryKey"> {
