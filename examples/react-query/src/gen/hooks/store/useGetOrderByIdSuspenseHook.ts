...
import { queryOptions, useSuspenseQuery } from "@tanstack/react-query";
 ...
 export const getOrderByIdSuspenseQueryKey = ({ orderId }: {
 ...
 */
async function getOrderByIdHook({ orderId }: {
    orderId: GetOrderByIdPathParams["orderId"];
 ...
 export function getOrderByIdSuspenseQueryOptionsHook({ orderId }: {
    orderId: GetOrderByIdPathParams["orderId"];
}, config: Partial<RequestConfig> = {}) {
 ...
 * {@link /store/order/:orderId}
 */
export function useGetOrderByIdSuspenseHook<TData = GetOrderByIdQueryResponse, TQueryData = GetOrderByIdQueryResponse, TQueryKey extends QueryKey = GetOrderByIdSuspenseQueryKey>({ orderId }: {
    orderId: GetOrderByIdPathParams["orderId"];
}, options: {
