 ...
 */
export async function getOrderByIdSuspenseHook({ orderId }: { orderId: GetOrderByIdPathParams["orderId"] }, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
 ...
 * {@link /store/order/:orderId}
 */
export function useGetOrderByIdSuspenseHook<TData = GetOrderByIdQueryResponse, TQueryData = GetOrderByIdQueryResponse, TQueryKey extends QueryKey = GetOrderByIdSuspenseQueryKey>({ orderId }: { orderId: GetOrderByIdPathParams["orderId"] }, options: 
  {
