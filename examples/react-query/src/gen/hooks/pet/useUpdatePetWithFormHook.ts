 ...
 * {@link /pet/:pet_id}
 */
export async function updatePetWithFormHook(pet_id: UpdatePetWithFormPathParams["pet_id"], params?: UpdatePetWithFormQueryParams, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
