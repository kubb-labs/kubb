 ...
 * {@link /pet/:pet_id}
 */
export async function updatePetWithFormHook(pet_id: UpdatePetWithFormPathParams["pet_id"], params?: UpdatePetWithFormQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
...
export function updatePetWithFormQueryOptionsHook(pet_id: UpdatePetWithFormPathParams["pet_id"], params?: UpdatePetWithFormQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
...
{
  query?: Partial<QueryObserverOptions<UpdatePetWithFormMutationResponse, ResponseErrorConfig<UpdatePetWithForm405>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
 ...
 = {}) {
  ...
  const query = useQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as QueryObserverOptions, queryClient) as UseQueryResult<TData, ResponseErrorConfig<UpdatePetWithForm405>> & { queryKey: TQueryKey }
