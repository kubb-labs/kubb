 ...
 * {@link /pet/:pet_id}
 */
export async function getPetByIdSuspenseHook({ pet_id }: { pet_id: GetPetByIdPathParams["pet_id"] }, config: Partial<RequestConfig> & { client?: typeof client } = {}) {
 ...
 * {@link /pet/:pet_id}
 */
export function useGetPetByIdSuspenseHook<TData = GetPetByIdQueryResponse, TQueryData = GetPetByIdQueryResponse, TQueryKey extends QueryKey = GetPetByIdSuspenseQueryKey>({ pet_id }: { pet_id: GetPetByIdPathParams["pet_id"] }, options: 
  {
