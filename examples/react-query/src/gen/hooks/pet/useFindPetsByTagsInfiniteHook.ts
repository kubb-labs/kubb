 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsInfiniteHook<TData = InfiniteData<ResponseConfig<FindPetsByTagsQueryResponse>>, TQueryData = ResponseConfig<FindPetsByTagsQueryResponse>, TQueryKey extends QueryKey = FindPetsByTagsInfiniteQueryKey>(params?: FindPetsByTagsQueryParams, options: {
