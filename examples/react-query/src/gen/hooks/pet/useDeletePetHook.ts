 ...
 * {@link /pet/:pet_id}
 */
async function deletePetHook({ pet_id }: { pet_id: DeletePetPathParams['pet_id'] }, headers?: DeletePetHeaderParams, config: Partial<RequestConfig> = {}) {
...
export function useDeletePetHook(
  options: {
    mutation?: UseMutationOptions<DeletePetMutationResponse, DeletePet400, { pet_id: DeletePetPathParams['pet_id']; headers?: DeletePetHeaderParams }>
  ...
  return useMutation<DeletePetMutationResponse, DeletePet400, { pet_id: DeletePetPathParams['pet_id']; headers?: DeletePetHeaderParams }>({
