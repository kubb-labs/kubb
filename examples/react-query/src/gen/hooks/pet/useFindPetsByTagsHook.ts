...
import { useClient } from "@kubb/plugin-client/clients/axios";
...
export function findPetsByTagsQueryOptionsHook(params?: FindPetsByTagsQueryParams, config: Partial<RequestConfig> = {}) {
  const client = useClient()      const queryKey = findPetsByTagsQueryKey(params)
 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsHook<TData = ResponseConfig<FindPetsByTagsQueryResponse>, TQueryData = ResponseConfig<FindPetsByTagsQueryResponse>, TQueryKey extends QueryKey = FindPetsByTagsQueryKey>(params?: FindPetsByTagsQueryParams, options: 
  {
