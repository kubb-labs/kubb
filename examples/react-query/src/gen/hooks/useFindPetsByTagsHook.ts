...
export function findPetsByTagsInfiniteQueryOptions<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"]>(params?: FindPetsByTags["queryParams"], options: FindPetsByTags["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<FindPetsByTags["response"], FindPetsByTags["error"], TData, TQueryData>, "queryKey"> {
