 ...
 * @link /user/logout
 */
export function useLogoutUserSuspenseHook<TData = LogoutUserQueryResponse, TQueryData = LogoutUserQueryResponse, TQueryKey extends QueryKey = LogoutUserSuspenseQueryKey>(options: {
