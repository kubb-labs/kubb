...
import { Mutation } from '@kubb/plugin-react-query/components'
import { useOperation, useOperationManager } from '@kubb/plugin-oas/hooks'
import type React from 'react'

export const templates = {
  ...Mutation.templates,
  react: function ({ name, params, JSDoc, client, hook, dataReturnType }: React.ComponentProps<typeof Mutation.templates.default>) {
