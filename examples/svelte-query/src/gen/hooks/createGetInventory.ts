 ...
 * {@link /store/inventory}
 */
export function createGetInventory<TData = GetInventoryQueryResponse, TQueryData = GetInventoryQueryResponse, TQueryKey extends QueryKey = GetInventoryQueryKey>(options: 
{
 ...
 = {}) {
  ...
  const query = createQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as CreateBaseQueryOptions, queryClient) as CreateQueryResult<TData, ResponseErrorConfig<Error>> & { queryKey: TQueryKey }
