...
export function loginUserQueryOptions<TData = LoginUser["response"], TQueryData = LoginUser["response"]>(params?: LoginUser["queryParams"], options: LoginUser["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<LoginUser["response"], LoginUser["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /user/login
 */
export function loginUserQuery<TData = LoginUser["response"], TQueryData = LoginUser["response"], TQueryKey extends QueryKey = LoginUserQueryKey>(params?: LoginUser["queryParams"], options: {
...
export function loginUserInfiniteQueryOptions<TData = LoginUser["response"], TQueryData = LoginUser["response"]>(params?: LoginUser["queryParams"], options: LoginUser["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<LoginUser["response"], LoginUser["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /user/login
 */
export function loginUserQueryInfinite<TData = InfiniteData<LoginUser["response"]>, TQueryData = LoginUser["response"], TQueryKey extends QueryKey = LoginUserInfiniteQueryKey>(params?: LoginUser["queryParams"], options: {
