...
export function findPetsByTagsQueryOptions<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"]>(params?: FindPetsByTags["queryParams"], options: FindPetsByTags["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<FindPetsByTags["response"], FindPetsByTags["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /pet/findByTags
 */
export function findPetsByTagsQuery<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"], TQueryKey extends QueryKey = FindPetsByTagsQueryKey>(params?: FindPetsByTags["queryParams"], options: {
...
export function findPetsByTagsInfiniteQueryOptions<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"]>(params?: FindPetsByTags["queryParams"], options: FindPetsByTags["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<FindPetsByTags["response"], FindPetsByTags["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /pet/findByTags
 */
export function findPetsByTagsQueryInfinite<TData = InfiniteData<FindPetsByTags["response"]>, TQueryData = FindPetsByTags["response"], TQueryKey extends QueryKey = FindPetsByTagsInfiniteQueryKey>(params?: FindPetsByTags["queryParams"], options: {
