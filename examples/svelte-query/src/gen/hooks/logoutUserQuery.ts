...
export function logoutUserQueryOptions<TData = LogoutUser["response"], TQueryData = LogoutUser["response"]>(options: LogoutUser["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<LogoutUser["response"], LogoutUser["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /user/logout
 */
export function logoutUserQuery<TData = LogoutUser["response"], TQueryData = LogoutUser["response"], TQueryKey extends QueryKey = LogoutUserQueryKey>(options: {
...
export function logoutUserInfiniteQueryOptions<TData = LogoutUser["response"], TQueryData = LogoutUser["response"]>(options: LogoutUser["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<LogoutUser["response"], LogoutUser["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /user/logout
 */
export function logoutUserQueryInfinite<TData = InfiniteData<LogoutUser["response"]>, TQueryData = LogoutUser["response"], TQueryKey extends QueryKey = LogoutUserInfiniteQueryKey>(options: {
