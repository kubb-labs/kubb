 ...
 * {@link /user/:username}
 */
export function createGetUserByName<TData = GetUserByNameQueryResponse, TQueryData = GetUserByNameQueryResponse, TQueryKey extends QueryKey = GetUserByNameQueryKey>(username: GetUserByNamePathParams["username"], options: 
{
  query?: Partial<CreateBaseQueryOptions<GetUserByNameQueryResponse, ResponseErrorConfig<GetUserByName400 | GetUserByName404>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
 ...
 = {}) {
  ...
  const query = createQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as CreateBaseQueryOptions, queryClient) as CreateQueryResult<TData, ResponseErrorConfig<GetUserByName400 | GetUserByName404>> & { queryKey: TQueryKey }
