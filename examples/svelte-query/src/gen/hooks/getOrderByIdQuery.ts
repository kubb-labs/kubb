...
export function getOrderByIdQueryOptions<TData = GetOrderById["response"], TQueryData = GetOrderById["response"]>(orderId: GetOrderByIdPathParams["orderId"], options: GetOrderById["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<GetOrderById["response"], GetOrderById["error"], TData, TQueryData>, "queryKey"> {
 ...
 */
export function getOrderByIdQuery<TData = GetOrderById["response"], TQueryData = GetOrderById["response"], TQueryKey extends QueryKey = GetOrderByIdQueryKey>(orderId: GetOrderByIdPathParams["orderId"], options: {
...
export function getOrderByIdInfiniteQueryOptions<TData = GetOrderById["response"], TQueryData = GetOrderById["response"]>(orderId: GetOrderByIdPathParams["orderId"], options: GetOrderById["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<GetOrderById["response"], GetOrderById["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /store/order/:orderId
 */
export function getOrderByIdQueryInfinite<TData = InfiniteData<GetOrderById["response"]>, TQueryData = GetOrderById["response"], TQueryKey extends QueryKey = GetOrderByIdInfiniteQueryKey>(orderId: GetOrderByIdPathParams["orderId"], options: {
