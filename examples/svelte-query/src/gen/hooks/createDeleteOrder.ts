 ...
 * {@link /store/order/:orderId}
 */
export function createDeleteOrder<TContext>(options: 
{
  mutation?: CreateMutationOptions<DeleteOrderMutationResponse, ResponseErrorConfig<DeleteOrder400 | DeleteOrder404>, {orderId: DeleteOrderPathParams["orderId"]}, TContext> & { client?: QueryClient },
 ...
 = {}) {
  ...
  return createMutation<DeleteOrderMutationResponse, ResponseErrorConfig<DeleteOrder400 | DeleteOrder404>, {orderId: DeleteOrderPathParams["orderId"]}, TContext>({
