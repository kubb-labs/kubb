 ...
 * {@link /pet/findByStatus}
 */
export function createFindPetsByStatus<TData = FindPetsByStatusQueryResponse, TQueryData = FindPetsByStatusQueryResponse, TQueryKey extends QueryKey = FindPetsByStatusQueryKey>(params?: FindPetsByStatusQueryParams, options: 
{
  query?: Partial<CreateBaseQueryOptions<FindPetsByStatusQueryResponse, ResponseErrorConfig<FindPetsByStatus400>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
 ...
 = {}) {
  ...
  const query = createQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as CreateBaseQueryOptions, queryClient) as CreateQueryResult<TData, ResponseErrorConfig<FindPetsByStatus400>> & { queryKey: TQueryKey }
