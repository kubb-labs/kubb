...
export function getInventoryQueryOptions<TData = GetInventory["response"], TQueryData = GetInventory["response"]>(options: GetInventory["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<GetInventory["response"], GetInventory["error"], TData, TQueryData>, "queryKey"> {
 ...
 */
export function getInventoryQuery<TData = GetInventory["response"], TQueryData = GetInventory["response"], TQueryKey extends QueryKey = GetInventoryQueryKey>(options: {
...
export function getInventoryInfiniteQueryOptions<TData = GetInventory["response"], TQueryData = GetInventory["response"]>(options: GetInventory["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<GetInventory["response"], GetInventory["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /store/inventory
 */
export function getInventoryQueryInfinite<TData = InfiniteData<GetInventory["response"]>, TQueryData = GetInventory["response"], TQueryKey extends QueryKey = GetInventoryInfiniteQueryKey>(options: {
