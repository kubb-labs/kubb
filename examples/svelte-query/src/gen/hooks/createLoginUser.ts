 ...
 * {@link /user/login}
 */
export function createLoginUser<TData = LoginUserQueryResponse, TQueryData = LoginUserQueryResponse, TQueryKey extends QueryKey = LoginUserQueryKey>(params?: LoginUserQueryParams, options: 
{
 ...
 = {}) {
  ...
  const query = createQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as CreateBaseQueryOptions, queryClient) as CreateQueryResult<TData, ResponseErrorConfig<LoginUser400>> & { queryKey: TQueryKey }
