...
export function getUserByNameQueryOptions<TData = GetUserByName["response"], TQueryData = GetUserByName["response"]>(username: GetUserByNamePathParams["username"], options: GetUserByName["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<GetUserByName["response"], GetUserByName["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /user/:username
 */
export function getUserByNameQuery<TData = GetUserByName["response"], TQueryData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameQueryKey>(username: GetUserByNamePathParams["username"], options: {
...
export function getUserByNameInfiniteQueryOptions<TData = GetUserByName["response"], TQueryData = GetUserByName["response"]>(username: GetUserByNamePathParams["username"], options: GetUserByName["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<GetUserByName["response"], GetUserByName["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /user/:username
 */
export function getUserByNameQueryInfinite<TData = InfiniteData<GetUserByName["response"]>, TQueryData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameInfiniteQueryKey>(username: GetUserByNamePathParams["username"], options: {
