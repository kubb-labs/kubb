...
export function findPetsByStatusQueryOptions<TData = FindPetsByStatus["response"], TQueryData = FindPetsByStatus["response"]>(params?: FindPetsByStatus["queryParams"], options: FindPetsByStatus["client"]["parameters"] = {}): WithRequired<CreateBaseQueryOptions<FindPetsByStatus["response"], FindPetsByStatus["error"], TData, TQueryData>, "queryKey"> {
 ...
 */
export function findPetsByStatusQuery<TData = FindPetsByStatus["response"], TQueryData = FindPetsByStatus["response"], TQueryKey extends QueryKey = FindPetsByStatusQueryKey>(params?: FindPetsByStatus["queryParams"], options: {
...
export function findPetsByStatusInfiniteQueryOptions<TData = FindPetsByStatus["response"], TQueryData = FindPetsByStatus["response"]>(params?: FindPetsByStatus["queryParams"], options: FindPetsByStatus["client"]["parameters"] = {}): WithRequired<CreateInfiniteQueryOptions<FindPetsByStatus["response"], FindPetsByStatus["error"], TData, TQueryData>, "queryKey"> {
 ...
 * @link /pet/findByStatus
 */
export function findPetsByStatusQueryInfinite<TData = InfiniteData<FindPetsByStatus["response"]>, TQueryData = FindPetsByStatus["response"], TQueryKey extends QueryKey = FindPetsByStatusInfiniteQueryKey>(params?: FindPetsByStatus["queryParams"], options: {
