 ...
 * {@link /user}
 */
export function createCreateUser<TContext>(options: 
{
  mutation?: CreateMutationOptions<CreateUserMutationResponse, ResponseErrorConfig<Error>, {data?: CreateUserMutationRequest}, TContext> & { client?: QueryClient },
