 ...
 * {@link /pet}
 */
export function createAddPet<TContext>(options: 
{
  mutation?: CreateMutationOptions<AddPetMutationResponse, ResponseErrorConfig<AddPet405>, {data: AddPetMutationRequest}, TContext> & { client?: QueryClient },
