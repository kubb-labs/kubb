...
export function createAddPet<TContext>(
  options: {
    mutation?: CreateMutationOptions<AddPetResponseData3, ResponseErrorConfig<AddPetStatus4053>, { data: AddPetRequestData3 }, TContext> & {
      client?: QueryClient
    }
  ...
  return createMutation<AddPetResponseData3, ResponseErrorConfig<AddPetStatus4053>, { data: AddPetRequestData3 }, TContext>(
    {
