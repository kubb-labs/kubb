...
export type { AddPetRequestStatusEnumKey, AddPetRequest } from './ts/models/AddPetRequest.ts'
...
export type { OrderHttpStatusEnumKey, Order } from './ts/models/Order.ts'
export type { StatusEnumKey, Pet } from './ts/models/Pet.ts'
