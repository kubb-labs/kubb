...
export const orderParamsEnumStatusEnum = {
  placed: 'placed',
  approved: 'approved',
  delivered: 'delivered',
} as const

export type OrderParamsEnumStatusEnumKey = (typeof orderParamsEnumStatusEnum)[keyof typeof orderParamsEnumStatusEnum]
...
export type Order = {
  ...
  params?: {
     ...
     * @type string
     */
    status: OrderParamsEnumStatusEnumKey
    /**
     * @type string
     */
    type: string
