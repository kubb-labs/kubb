...
export enum PostPetRequestStatusEnum {
  available = 'available',
  pending = 'pending',
  sold = 'sold',
}
...
export interface CreatePetsPathParams {
  /**
   * @description UUID
   * @type string
   */
...
export enum CreatePetsQueryParamsBoolParamEnum {
  true = 'true',
}

export interface CreatePetsQueryParams {
  /**
   * @type string | undefined
   */
...
export enum CreatePetsHeaderParamsXEXAMPLEEnum {
  ONE = 'ONE',
  TWO = 'TWO',
  THREE = 'THREE',
}

export interface CreatePetsHeaderParams {
  /**
...
export interface CreatePetsRequestData {
  /**
   * @type string
   */
  name: string
 ...
 */
export interface UpdatePetStatus202 {
  /**
   * @type integer | undefined, int64
   */
  id?: number
...
export interface FindPetsByStatusPathParams {
  /**
   * @type string
   */
  step_id: string
...
export enum FindPetsByTagsHeaderParamsXEXAMPLEEnum {
  ONE = 'ONE',
  TWO = 'TWO',
  THREE = 'THREE',
}

export interface FindPetsByTagsHeaderParams {
  /**
   * @description Header parameters
   * @type string
   */
