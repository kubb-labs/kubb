...
export type { DeletePetPathParams, DeletePetHeaderParams, DeletePet200EnumKey, DeletePet200, DeletePet400, DeletePetMutationResponse, DeletePetMutation } from "./DeletePet.ts";
