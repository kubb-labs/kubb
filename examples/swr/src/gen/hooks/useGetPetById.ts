 ...
 * {@link /pet/:petId}
 */
export function useGetPetById(petId: GetPetByIdPathParams["petId"], options: 
{
 ...
 = {}) {
  ...
  return useSWR<GetPetByIdQueryResponse, ResponseErrorConfig<GetPetById400 | GetPetById404>, GetPetByIdQueryKey | null>(
