...
export function getUserByNameQueryOptions<TData = GetUserByName["response"]>(username: GetUserByNamePathParams["username"], options: GetUserByName["client"]["parameters"] = {}): SWRConfiguration<TData, GetUserByName["error"]> {
    return {
        fetcher: async () => {
