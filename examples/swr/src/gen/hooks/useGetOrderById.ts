...
export function getOrderByIdQueryOptions<TData = GetOrderById["response"]>(orderId: GetOrderByIdPathParams["orderId"], options: GetOrderById["client"]["parameters"] = {}): SWRConfiguration<TData, GetOrderById["error"]> {
    return {
        fetcher: async () => {
 ...
 */
export function useGetOrderById<TData = GetOrderById["response"]>(orderId: GetOrderByIdPathParams["orderId"], options?: {
