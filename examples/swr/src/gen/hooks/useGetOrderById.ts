 ...
 * {@link /store/order/:orderId}
 */
export function useGetOrderById(orderId: GetOrderByIdPathParams["orderId"], options: 
{
 ...
 = {}) {
  ...
  return useSWR<GetOrderByIdQueryResponse, ResponseErrorConfig<GetOrderById400 | GetOrderById404>, GetOrderByIdQueryKey | null>(
