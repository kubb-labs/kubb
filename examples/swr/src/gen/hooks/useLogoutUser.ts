...
export function useLogoutUser(
  options: {
    query?: Parameters<typeof useSWR<LogoutUserResponseData, ResponseErrorConfig<Error>>>[2]
  ...
  return useSWR<LogoutUserResponseData, ResponseErrorConfig<Error>, LogoutUserQueryKey | null>(shouldFetch ? queryKey : null, {
