...
{
  mutation?: ReturnType<UseMutationOptions<DeleteUserMutationResponse, ResponseErrorConfig<DeleteUser400 | DeleteUser404>, {username: DeleteUserPathParams["username"]}, TContext>> & { client?: QueryClient },
