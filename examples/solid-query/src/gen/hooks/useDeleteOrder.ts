...
{
  mutation?: ReturnType<UseMutationOptions<DeleteOrderMutationResponse, ResponseErrorConfig<DeleteOrder400 | DeleteOrder404>, {orderId: DeleteOrderPathParams["orderId"]}, TContext>> & { client?: QueryClient },
