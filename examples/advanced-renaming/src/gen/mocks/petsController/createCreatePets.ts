...
import type { CreatePets201, CreatePetsError, CreatePetsHeaderParams, CreatePetsMutationRequest, CreatePetsMutationResponse, CreatePetsPathParams, CreatePetsQueryParams } from "../../models/ts/petsController/CreatePets";
 ...
 */
 ...
 export function createCreatePetsPathParams(): NonNullable<CreatePetsPathParams> {
    return { "pet-id": faker.string.alpha() };
}
