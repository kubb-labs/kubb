...
import type { UpdatePetWithForm405, UpdatePetWithFormMutationResponse, UpdatePetWithFormPathParams, UpdatePetWithFormQueryParams } from "../../models/ts/petController/UpdatePetWithForm";
