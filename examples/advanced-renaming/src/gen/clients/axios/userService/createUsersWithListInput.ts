...
export async function createUsersWithListInput(data?: CreateUsersWithListInputMutationRequest, options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<CreateUsersWithListInputMutationResponse>> {
