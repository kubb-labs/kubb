...
/**
     ...
     * @summary Update user
     * @link /user/:username */
export async function updateUser({ username }: UpdateUserPathParams, data?: UpdateUserMutationRequest, options: Partial<Parameters<typeof client>[0]> = {}): Promise<ResponseConfig<UpdateUserMutationResponse>> {
