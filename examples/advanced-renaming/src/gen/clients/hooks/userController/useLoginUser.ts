...
export function loginUserInfiniteQueryOptions<TData = LoginUser["response"], TQueryData = LoginUser["response"]>(params?: LoginUser["queryParams"], options: LoginUser["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<LoginUser["response"], LoginUser["error"], TData, TQueryData>, "queryKey"> {
...
/**
     * @summary Logs user into the system
     * @link /user/login */
export function useLoginUserInfinite<TData = InfiniteData<LoginUser["response"]>, TQueryData = LoginUser["response"], TQueryKey extends QueryKey = LoginUserInfiniteQueryKey>(params?: LoginUser["queryParams"], options: {
