...
export function getUserByNameInfiniteQueryOptions<TData = GetUserByName["response"], TQueryData = GetUserByName["response"]>(username: GetUserByNamePathParams["username"], options: GetUserByName["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<GetUserByName["response"], GetUserByName["error"], TData, TQueryData>, "queryKey"> {
...
/**
     * @summary Get user by user name
     * @link /user/:username */
export function useGetUserByNameInfinite<TData = InfiniteData<GetUserByName["response"]>, TQueryData = GetUserByName["response"], TQueryKey extends QueryKey = GetUserByNameInfiniteQueryKey>(username: GetUserByNamePathParams["username"], options: {
