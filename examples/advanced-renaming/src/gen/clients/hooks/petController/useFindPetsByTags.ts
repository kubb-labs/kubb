...
import type { FindPetsByTagsQueryResponse, FindPetsByTagsQueryParams, FindPetsByTagsHeaderParams, FindPetsByTags400 } from "../../../models/ts/petController/FindPetsByTags";
...
export function findPetsByTagsQueryOptions<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"]>(headers: FindPetsByTags["headerParams"], params?: FindPetsByTags["queryParams"], options: FindPetsByTags["client"]["parameters"] = {}): WithRequired<UseBaseQueryOptions<FindPetsByTags["response"], FindPetsByTags["error"], TData, TQueryData>, "queryKey"> {
...
/**
     ...
     * @link /pet/findByTags */
export function useFindPetsByTags<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"], TQueryKey extends QueryKey = FindPetsByTagsQueryKey>(headers: FindPetsByTags["headerParams"], params?: FindPetsByTags["queryParams"], options: {
...
export function findPetsByTagsInfiniteQueryOptions<TData = FindPetsByTags["response"], TQueryData = FindPetsByTags["response"]>(headers: FindPetsByTags["headerParams"], params?: FindPetsByTags["queryParams"], options: FindPetsByTags["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<FindPetsByTags["response"], FindPetsByTags["error"], TData, TQueryData>, "queryKey"> {
...
/**
     ...
     * @summary Finds Pets by tags
     * @link /pet/findByTags */
export function useFindPetsByTagsInfinite<TData = InfiniteData<FindPetsByTags["response"]>, TQueryData = FindPetsByTags["response"], TQueryKey extends QueryKey = FindPetsByTagsInfiniteQueryKey>(headers: FindPetsByTags["headerParams"], params?: FindPetsByTags["queryParams"], options: {
