...
export function getPetByIdInfiniteQueryOptions<TData = GetPetById["response"], TQueryData = GetPetById["response"]>(petId: GetPetByIdPathParams["petId"], options: GetPetById["client"]["parameters"] = {}): WithRequired<UseInfiniteQueryOptions<GetPetById["response"], GetPetById["error"], TData, TQueryData>, "queryKey"> {
...
/**
     ...
     * @summary Find pet by ID
     * @link /pet/:petId */
export function useGetPetByIdInfinite<TData = InfiniteData<GetPetById["response"]>, TQueryData = GetPetById["response"], TQueryKey extends QueryKey = GetPetByIdInfiniteQueryKey>(petId: GetPetByIdPathParams["petId"], options: {
