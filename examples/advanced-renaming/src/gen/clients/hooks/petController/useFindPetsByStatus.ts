...
/**
     ...
     * @summary Finds Pets by status
     * @link /pet/findByStatus */
export function useFindPetsByStatusInfinite<TData = InfiniteData<FindPetsByStatus["response"]>, TQueryData = FindPetsByStatus["response"], TQueryKey extends QueryKey = FindPetsByStatusInfiniteQueryKey>(params?: FindPetsByStatus["queryParams"], options: {
