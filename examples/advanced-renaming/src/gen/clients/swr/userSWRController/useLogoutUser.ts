...
export function logoutUserQueryOptions<TData extends LogoutUser["response"] = LogoutUser["response"], TError = LogoutUser["error"]>(options: LogoutUser["client"]["parameters"] = {}): SWRConfiguration<TData, TError> {
    return {
        fetcher: async () => {
