...
export function getPetByIdQueryOptions<TData extends GetPetById["response"] = GetPetById["response"], TError = GetPetById["error"]>(petId: GetPetByIdPathParams["petId"], options: GetPetById["client"]["parameters"] = {}): SWRConfiguration<TData, TError> {
    return {
        fetcher: async () => {
...
/**
     ...
     * @link /pet/:petId */
export function useGetPetById<TData extends GetPetById["response"] = GetPetById["response"], TError = GetPetById["error"]>(petId: GetPetByIdPathParams["petId"], options?: {
