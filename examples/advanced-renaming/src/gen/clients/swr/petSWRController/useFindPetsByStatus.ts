...
export function findPetsByStatusQueryOptions<TData extends FindPetsByStatus["response"] = FindPetsByStatus["response"], TError = FindPetsByStatus["error"]>(params?: FindPetsByStatus["queryParams"], options: FindPetsByStatus["client"]["parameters"] = {}): SWRConfiguration<TData, TError> {
    return {
        fetcher: async () => {
...
export function useFindPetsByStatus<TData extends FindPetsByStatus["response"] = FindPetsByStatus["response"], TError = FindPetsByStatus["error"]>(params?: FindPetsByStatus["queryParams"], options?: {
