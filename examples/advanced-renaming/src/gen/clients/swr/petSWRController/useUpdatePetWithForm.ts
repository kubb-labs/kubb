...
import type { UpdatePetWithFormMutationResponse, UpdatePetWithFormPathParams, UpdatePetWithFormQueryParams, UpdatePetWithForm405 } from "../../../models/ts/petController/UpdatePetWithForm";
...
export function useUpdatePetWithForm(petId: UpdatePetWithFormPathParams["petId"], params?: UpdatePetWithForm["queryParams"], options?: {
    ...
    return useSWRMutation<UpdatePetWithForm["response"], UpdatePetWithForm["error"], [
        typeof url,
        typeof params
    ] | null>(shouldFetch ? [url, params] : null, async (_url) => {
