...
import type { CreatePetsMutationRequest, CreatePetsMutationResponse, CreatePetsPathParams, CreatePetsQueryParams, CreatePetsHeaderParams, CreatePets201, CreatePetsError } from "../../../models/ts/petsController/CreatePets";
...
/**
     ...
     * @link /pets/:pet-id */
export function useCreatePets(petId: CreatePetsPathParams["pet-id"], params?: CreatePets["queryParams"], headers?: CreatePets["headerParams"], options?: {
    ...
    return useSWRMutation<CreatePets["response"], CreatePets["error"], [
        typeof url,
        typeof params
