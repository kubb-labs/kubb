...
import { createPetsMutationRequestSchema, createPetsPathParamsSchema, createPetsQueryParamsSchema, createPetsHeaderParamsSchema } from "../zod/createPetsSchema.js";
...
server.tool("updatePetWithForm", "Make a POST request to /pet/{petId}", { petId: updatePetWithFormPathParamsSchema.shape['petId'], params: updatePetWithFormQueryParamsSchema }, async ({ petId, params }) => {
...
server.tool("getOrderById", "For valid response try integer IDs with value <= 5 or > 10. Other values will generate exceptions.", { orderId: getOrderByIdPathParamsSchema.shape['orderId'] }, async ({ orderId }) => {
  return getOrderByIdHandler({ orderId })
})
          
server.tool("deleteOrder", "For valid response try integer IDs with value < 1000. Anything above 1000 or nonintegers will generate API errors", { orderId: deleteOrderPathParamsSchema.shape['orderId'] }, async ({ orderId }) => {
