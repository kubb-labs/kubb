...
import type { FindPetsByTagsQueryResponse, FindPetsByTagsQueryParams, FindPetsByTags400 } from '../models/ts/FindPetsByTags.js'
import type { RequestConfig, ResponseErrorConfig } from '@kubb/plugin-client/clients/axios'

function getFindPetsByTagsUrl() {
  return 'https://petstore.swagger.io/v2/pet/findByTags' as const
}
