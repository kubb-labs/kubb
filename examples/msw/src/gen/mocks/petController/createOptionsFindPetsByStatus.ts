...
export function createOptionsFindPetsByStatusMutationResponse(data?: Partial<OptionsFindPetsByStatusMutationResponse>): OptionsFindPetsByStatusMutationResponse {
  faker.seed([220])  
