 ...
 */
export function createAddPet405(data?: Partial<AddPet405>): Partial<AddPet405> {
  faker.seed([220])
  return {
...
export function createAddPetMutationResponse(data?: Partial<AddPetMutationResponse>): Partial<AddPetMutationResponse> {
  faker.seed([220])
