...
export function getOrderByIdQueryOptions<TData = GetOrderById["response"], TQueryData = GetOrderById["response"]>(refOrderId: MaybeRef<GetOrderByIdPathParams["orderId"]>, options: GetOrderById["client"]["parameters"] = {}): WithRequired<VueQueryObserverOptions<GetOrderById["response"], GetOrderById["error"], TData, TQueryData>, "queryKey"> {
