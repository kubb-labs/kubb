...
async function findPetsByStatus({ params }: {
 ...
 export function findPetsByStatusQueryOptions({ params }: {
 ...
 * {@link /pet/findByStatus}
 */
export function useFindPetsByStatus<TData = FindPetsByStatusQueryResponse, TQueryData = FindPetsByStatusQueryResponse, TQueryKey extends QueryKey = FindPetsByStatusQueryKey>({ params }: {
    params?: MaybeRef<FindPetsByStatusQueryParams>;
}, options: {
