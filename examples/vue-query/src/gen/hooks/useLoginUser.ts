...
export function loginUserQueryOptions<TData = LoginUser["response"], TQueryData = LoginUser["response"]>(refParams?: MaybeRef<LoginUserQueryParams>, options: LoginUser["client"]["parameters"] = {}): WithRequired<VueQueryObserverOptions<LoginUser["response"], LoginUser["error"], TData, TQueryData>, "queryKey"> {
