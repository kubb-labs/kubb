...
export function logoutUserQueryOptions<TData = LogoutUser["response"], TQueryData = LogoutUser["response"]>(options: LogoutUser["client"]["parameters"] = {}): WithRequired<VueQueryObserverOptions<LogoutUser["response"], LogoutUser["error"], TData, TQueryData>, "queryKey"> {
