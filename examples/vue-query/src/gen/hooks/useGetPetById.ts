...
export function getPetByIdQueryOptions<TData = GetPetById["response"], TQueryData = GetPetById["response"]>(refPetId: MaybeRef<GetPetByIdPathParams["petId"]>, options: GetPetById["client"]["parameters"] = {}): WithRequired<VueQueryObserverOptions<GetPetById["response"], GetPetById["error"], TData, TQueryData>, "queryKey"> {
