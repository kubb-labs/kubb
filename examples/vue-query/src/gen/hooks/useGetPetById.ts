...
import { unref } from "vue";
 ...
 export const getPetByIdQueryKey = ({ petId }: {
    petId: MaybeRef<GetPetByIdPathParams["petId"]>;
 ...
 * {@link /pet/:petId}
 */
export function useGetPetById<TData = GetPetByIdQueryResponse, TQueryData = GetPetByIdQueryResponse, TQueryKey extends QueryKey = GetPetByIdQueryKey>({ petId }: {
    petId: MaybeRef<GetPetByIdPathParams["petId"]>;
}, options: {
