...
async function updatePet({ data }: {
    ...
    const res = await client<UpdatePetMutationResponse, UpdatePet400 | UpdatePet404 | UpdatePet405, UpdatePetMutationRequest>({ method: "PUT", url: `/pet`, data, ...config });
    return res.data;
}
...
export function useUpdatePet(options: {
    mutation?: MutationObserverOptions<UpdatePetMutationResponse, UpdatePet400 | UpdatePet404 | UpdatePet405, {
