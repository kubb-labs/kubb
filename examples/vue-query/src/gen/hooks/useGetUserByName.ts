 ...
 * {@link /user/:username}
 */
export function useGetUserByName<TData = GetUserByNameQueryResponse, TQueryData = GetUserByNameQueryResponse, TQueryKey extends QueryKey = GetUserByNameQueryKey>({ username }: {
    username: MaybeRef<GetUserByNamePathParams["username"]>;
}, options: {
