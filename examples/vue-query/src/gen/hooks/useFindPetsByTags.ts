...
export function findPetsByTagsQueryOptions(params?: MaybeRefOrGetter<FindPetsByTagsQueryParams>, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
...
export function useFindPetsByTags<TData = FindPetsByTagsQueryResponse, TQueryData = FindPetsByTagsQueryResponse, TQueryKey extends QueryKey = FindPetsByTagsQueryKey>(params?: MaybeRefOrGetter<FindPetsByTagsQueryParams>, options: 
{
 ...
 = {}) {
  ...
  const query = useQuery({
   ...
   queryKey,
   ...queryOptions
  } as unknown as QueryObserverOptions, queryClient) as UseQueryReturnType<TData, ResponseErrorConfig<FindPetsByTags400>> & { queryKey: TQueryKey }
