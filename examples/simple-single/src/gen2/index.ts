...
export const appSchema = z.object({ "id": z.string().optional(), "name": z.string().optional(), "organization": z.lazy(() => organizationSchema).optional(), "status": z.string().optional() });
 ...
 export const processStatSchema = z.object({ "command": z.string().optional(), "cpu": z.number().optional(), "directory": z.string().optional(), "listen_sockets": z.array(z.lazy(() => listenSocketSchema)).optional(), "pid": z.number().optional(), "rss": z.number().optional(), "rtime": z.number().optional(), "stime": z.number().optional() });
 ...
 export const volumeSnapshotSchema = z.object({ "created_at": z.string().optional(), "digest": z.string().optional(), "id": z.string().optional(), "size": z.number().optional(), "status": z.string().optional() });



 export const flyDnsConfigSchema = z.object({ "dns_forward_rules": z.array(z.lazy(() => flyDnsForwardRuleSchema)).optional(), "nameservers": z.array(z.string()).optional(), "options": z.array(z.lazy(() => flyDnsOptionSchema)).optional(), "searches": z.array(z.string()).optional(), "skip_registration": z.boolean().optional() });
 ...
 export const flyMachinePortSchema = z.object({ "end_port": z.number().optional(), "force_https": z.boolean().optional(), "handlers": z.array(z.string()).optional(), "http_options": z.lazy(() => flyHttpOptionsSchema).optional(), "port": z.number().optional(), "proxy_proto_options": z.lazy(() => flyProxyProtoOptionsSchema).optional(), "start_port": z.number().optional(), "tls_options": z.lazy(() => flyTlsOptionsSchema).optional() });
 ...
 export const flyMachineServiceSchema = z.object({ "autostart": z.boolean().optional(), "autostop": z.boolean().optional(), "checks": z.array(z.lazy(() => flyMachineCheckSchema)).optional(), "concurrency": z.lazy(() => flyMachineServiceConcurrencySchema).optional(), "force_instance_description": z.string().optional(), "force_instance_key": z.string().optional(), "internal_port": z.number().optional(), "min_machines_running": z.number().optional(), "ports": z.array(z.lazy(() => flyMachinePortSchema)).optional(), "protocol": z.string().optional() });
...
export const machinesRestartQueryParamsSchema = z.object({ "timeout": z.string().describe("Restart timeout as a Go duration string or number of seconds").optional() }).optional();
 ...
 * @description Request body
 */
export const machinesGetOidcTokenMutationRequestSchema = z.lazy(() => createOidcTokenRequestSchema);
