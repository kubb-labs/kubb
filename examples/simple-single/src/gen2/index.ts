...
export const appSchema = z.object({ "id": z.string().optional(), "name": z.string().optional(), "organization": z.lazy(() => organizationSchema).schema.optional(), "status": z.string().optional() });
 ...
 export const createVolumeRequestSchema = z.object({ "compute": z.lazy(() => flyMachineGuestSchema).schema.optional(), "compute_image": z.string().optional(), "encrypted": z.boolean().optional(), "fstype": z.string().optional(), "machines_only": z.boolean().optional(), "name": z.string().optional(), "region": z.string().optional(), "require_unique_zone": z.boolean().optional(), "size_gb": z.number().optional(), "snapshot_id": z.string().describe("restore from snapshot").optional(), "snapshot_retention": z.number().optional(), "source_volume_id": z.string().describe("fork from remote volume").optional() });



 export const errorResponseSchema = z.object({ "details": z.object({}).describe("Deprecated").optional(), "error": z.string().optional(), "status": z.lazy(() => mainStatusCodeSchema).schema.optional() });
 ...
 export const machineSchema = z.object({ "checks": z.array(z.lazy(() => checkStatusSchema).schema).optional(), "config": z.lazy(() => flyMachineConfigSchema).schema.optional(), "created_at": z.string().optional(), "events": z.array(z.lazy(() => machineEventSchema).schema).optional(), "host_status": z.enum(["ok", "unknown", "unreachable"]).optional(), "id": z.string().optional(), "image_ref": z.lazy(() => imageRefSchema).schema.optional(), "instance_id": z.string().describe("InstanceID is unique for each version of the machine").optional(), "name": z.string().optional(), "nonce": z.string().describe("Nonce is only every returned on machine creation if a lease_duration was provided.").optional(), "private_ip": z.string().describe("PrivateIP is the internal 6PN address of the machine.").optional(), "region": z.string().optional(), "state": z.string().optional(), "updated_at": z.string().optional() });



 export const machineEventSchema = z.object({ "id": z.string().optional(), "request": z.object({}).optional(), "source": z.string().optional(), "status": z.string().optional(), "timestamp": z.number().optional(), "type": z.string().optional() });



 export const machineExecRequestSchema = z.object({ "cmd": z.string().describe("Deprecated: use Command instead").optional(), "command": z.array(z.string()).optional(), "timeout": z.number().optional() });
 ...
 export const processStatSchema = z.object({ "command": z.string().optional(), "cpu": z.number().optional(), "directory": z.string().optional(), "listen_sockets": z.array(z.lazy(() => listenSocketSchema).schema).optional(), "pid": z.number().optional(), "rss": z.number().optional(), "rtime": z.number().optional(), "stime": z.number().optional() });
 ...
 export const updateMachineRequestSchema = z.object({ "config": z.lazy(() => flyMachineConfigSchema).schema.describe("An object defining the Machine configuration").optional(), "current_version": z.string().optional(), "lease_ttl": z.number().optional(), "lsvd": z.boolean().optional(), "name": z.string().describe("Unique name for this Machine. If omitted, one is generated for you").optional(), "region": z.string().describe("The target region. Omitting this param launches in the same region as your WireGuard peer connection (somewhere near you).").optional(), "skip_launch": z.boolean().optional(), "skip_service_registration": z.boolean().optional() });
 ...
 export const volumeSchema = z.object({ "attached_alloc_id": z.string().optional(), "attached_machine_id": z.string().optional(), "auto_backup_enabled": z.boolean().optional(), "block_size": z.number().optional(), "blocks": z.number().optional(), "blocks_avail": z.number().optional(), "blocks_free": z.number().optional(), "created_at": z.string().optional(), "encrypted": z.boolean().optional(), "fstype": z.string().optional(), "host_status": z.enum(["ok", "unknown", "unreachable"]).optional(), "id": z.string().optional(), "name": z.string().optional(), "region": z.string().optional(), "size_gb": z.number().optional(), "snapshot_retention": z.number().optional(), "state": z.string().optional(), "zone": z.string().optional() });



 export const volumeSnapshotSchema = z.object({ "created_at": z.string().optional(), "digest": z.string().optional(), "id": z.string().optional(), "retention_days": z.number().optional(), "size": z.number().optional(), "status": z.string().optional() });



 export const flyDnsConfigSchema = z.object({ "dns_forward_rules": z.array(z.lazy(() => flyDnsForwardRuleSchema).schema).optional(), "nameservers": z.array(z.string()).optional(), "options": z.array(z.lazy(() => flyDnsOptionSchema).schema).optional(), "searches": z.array(z.string()).optional(), "skip_registration": z.boolean().optional() });
 ...
 export const flyHttpOptionsSchema = z.object({ "compress": z.boolean().optional(), "h2_backend": z.boolean().optional(), "response": z.lazy(() => flyHttpResponseOptionsSchema).schema.optional() });
 ...
 export const flyMachineCheckSchema = z.object({ "grace_period": z.lazy(() => flyDurationSchema).schema.describe("The time to wait after a VM starts before checking its health").optional(), "headers": z.array(z.lazy(() => flyMachineHttpHeaderSchema).schema).optional(), "interval": z.lazy(() => flyDurationSchema).schema.describe("The time between connectivity checks").optional(), "method": z.string().describe("For http checks, the HTTP method to use to when making the request").optional(), "path": z.string().describe("For http checks, the path to send the request to").optional(), "port": z.number().describe("The port to connect to, often the same as internal_port").optional(), "protocol": z.string().describe("For http checks, whether to use http or https").optional(), "timeout": z.lazy(() => flyDurationSchema).schema.describe("The maximum time a connection can take before being reported as failing its health check").optional(), "tls_server_name": z.string().describe("If the protocol is https, the hostname to use for TLS certificate validation").optional(), "tls_skip_verify": z.boolean().describe("For http checks with https protocol, whether or not to verify the TLS certificate").optional(), "type": z.string().describe("tcp or http").optional() }).describe("An optional object that defines one or more named checks. The key for each check is the check name.");



 export const flyMachineConfigSchema = z.object({ "auto_destroy": z.boolean().describe("Optional boolean telling the Machine to destroy itself once it\u2019s complete (default false)").optional(), "checks": z.object({}).catchall(z.lazy(() => flyMachineCheckSchema).schema).optional(), "disable_machine_autostart": z.boolean().describe("Deprecated: use Service.Autostart instead").optional(), "dns": z.lazy(() => flyDnsConfigSchema).schema.optional(), "env": z.object({}).catchall(z.string()).describe("An object filled with key/value pairs to be set as environment variables").optional(), "files": z.array(z.lazy(() => flyFileSchema).schema).optional(), "guest": z.lazy(() => flyMachineGuestSchema).schema.optional(), "image": z.string().describe("The docker image to run").optional(), "init": z.lazy(() => flyMachineInitSchema).schema.optional(), "metadata": z.object({}).catchall(z.string()).optional(), "metrics": z.lazy(() => flyMachineMetricsSchema).schema.optional(), "mounts": z.array(z.lazy(() => flyMachineMountSchema).schema).optional(), "processes": z.array(z.lazy(() => flyMachineProcessSchema).schema).optional(), "restart": z.lazy(() => flyMachineRestartSchema).schema.optional(), "schedule": z.string().optional(), "services": z.array(z.lazy(() => flyMachineServiceSchema).schema).optional(), "size": z.string().describe("Deprecated: use Guest instead").optional(), "standbys": z.array(z.string()).describe("Standbys enable a machine to be a standby for another. In the event of a hardware failure,\nthe standby machine will be started.").optional(), "statics": z.array(z.lazy(() => flyStaticSchema).schema).optional(), "stop_config": z.lazy(() => flyStopConfigSchema).schema.optional() });



 export const flyMachineGuestSchema = z.object({ "cpu_kind": z.string().optional(), "cpus": z.number().optional(), "gpu_kind": z.string().optional(), "gpus": z.number().optional(), "host_dedication_id": z.string().optional(), "kernel_args": z.array(z.string()).optional(), "memory_mb": z.number().optional() });
 ...
 export const flyMachineInitSchema = z.object({ "cmd": z.array(z.string()).optional(), "entrypoint": z.array(z.string()).optional(), "exec": z.array(z.string()).optional(), "kernel_args": z.array(z.string()).optional(), "swap_size_mb": z.number().optional(), "tty": z.boolean().optional() });
 ...
 export const flyMachineMountSchema = z.object({ "add_size_gb": z.number().optional(), "encrypted": z.boolean().optional(), "extend_threshold_percent": z.number().optional(), "name": z.string().optional(), "path": z.string().optional(), "size_gb": z.number().optional(), "size_gb_limit": z.number().optional(), "volume": z.string().optional() });



 export const flyMachinePortSchema = z.object({ "end_port": z.number().optional(), "force_https": z.boolean().optional(), "handlers": z.array(z.string()).optional(), "http_options": z.lazy(() => flyHttpOptionsSchema).schema.optional(), "port": z.number().optional(), "proxy_proto_options": z.lazy(() => flyProxyProtoOptionsSchema).schema.optional(), "start_port": z.number().optional(), "tls_options": z.lazy(() => flyTlsOptionsSchema).schema.optional() });



 export const flyMachineProcessSchema = z.object({ "cmd": z.array(z.string()).optional(), "entrypoint": z.array(z.string()).optional(), "env": z.object({}).catchall(z.string()).optional(), "env_from": z.array(z.lazy(() => flyEnvFromSchema).schema).describe("EnvFrom can be provided to set environment variables from machine fields.").optional(), "exec": z.array(z.string()).optional(), "ignore_app_secrets": z.boolean().describe("IgnoreAppSecrets can be set to true to ignore the secrets for the App the Machine belongs to\nand only use the secrets provided at the process level. The default/legacy behavior is to use\nthe secrets provided at the App level.").optional(), "secrets": z.array(z.lazy(() => flyMachineSecretSchema).schema).describe("Secrets can be provided at the process level to explicitly indicate which secrets should be\nused for the process. If not provided, the secrets provided at the machine level will be used.").optional(), "user": z.string().optional() });



 export const flyMachineRestartSchema = z.object({ "max_retries": z.number().describe("When policy is on-failure, the maximum number of times to attempt to restart the Machine before letting it stop.").optional(), "policy": z.enum(["no", "always", "on-failure"]).describe("* no - Never try to restart a Machine automatically when its main process exits, whether that\u2019s on purpose or on a crash.\n* always - Always restart a Machine automatically and never let it enter a stopped state, even when the main process exits cleanly.\n* on-failure - Try up to MaxRetries times to automatically restart the Machine if it exits with a non-zero exit code. Default when no explicit policy is set, and for Machines with schedules.").optional() }).describe("The Machine restart policy defines whether and how flyd restarts a Machine after its main process exits. See https://fly.io/docs/machines/guides-examples/machine-restart-policy/.");
 ...
 export const flyMachineServiceSchema = z.object({ "autostart": z.boolean().optional(), "autostop": z.boolean().optional(), "checks": z.array(z.lazy(() => flyMachineCheckSchema).schema).optional(), "concurrency": z.lazy(() => flyMachineServiceConcurrencySchema).schema.optional(), "force_instance_description": z.string().optional(), "force_instance_key": z.string().optional(), "internal_port": z.number().optional(), "min_machines_running": z.number().optional(), "ports": z.array(z.lazy(() => flyMachinePortSchema).schema).optional(), "protocol": z.string().optional() });



 export const flyMachineServiceConcurrencySchema = z.object({ "hard_limit": z.number().optional(), "soft_limit": z.number().optional(), "type": z.string().optional() });
...
export const machinesWaitQueryParamsSchema = z.object({ "instance_id": z.string().describe("instance? version? TODO").optional(), "timeout": z.number().describe("wait timeout. default 60s").optional(), "state": z.enum(["started", "stopped", "destroyed"]).describe("desired state").optional() }).optional();
