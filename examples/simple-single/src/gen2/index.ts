...
export const appsDelete202Schema = z.any();
 ...
 export const machinesListQueryParamsSchema = z.object({ "include_deleted": z.boolean().describe("Include deleted machines").optional(), "region": z.string().describe("Region filter").optional(), "summary": z.boolean().describe("Only return summary info about machines (omit config, checks, events, host_status, nonce, etc.)").optional() }).optional();
