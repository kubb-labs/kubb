...
export const appsDelete202Schema = z.any();
 ...
 export const machinesListQueryParamsSchema = z.object({ "include_deleted": z.boolean().describe("Include deleted machines").optional(), "region": z.string().describe("Region filter").optional() }).optional();
