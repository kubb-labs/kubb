...
export const tagSchema = z.object({ id: z.number().int().optional(), name: z.string().optional() })
 ...
 * @description successful operation
 */
export const getInventoryQueryResponseSchema = z.object({}).catchall(z.number().int())
