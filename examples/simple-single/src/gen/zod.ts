...
export const orderSchema = z.object({ "id": z.number().optional(), "petId": z.number().optional(), "quantity": z.number().optional(), "shipDate": z.string().datetime().optional(), "status": z.enum(["placed", "approved", "delivered"]).describe("Order Status").optional(), "http_status": z.union([z.literal(200), z.literal(400), z.literal(500)]).describe("HTTP Status's and item of this").optional(), "complete": z.boolean().optional() });
 ...
 export const petSchema = z.object({ "id": z.number().optional(), "name": z.string(), "category": z.lazy(() => categorySchema).optional(), "photoUrls": z.array(z.string()), "tags": z.array(z.lazy(() => tagSchema)).optional(), "status": z.enum(["available", "pending", "sold"]).describe("pet status in the store").optional() });



 export const addPetRequestSchema = z.object({ "id": z.number().optional(), "name": z.string(), "category": z.lazy(() => categorySchema).optional(), "photoUrls": z.array(z.string()), "tags": z.array(z.lazy(() => tagSchema)).optional(), "status": z.enum(["available", "pending", "sold"]).describe("pet status in the store").optional() });
