...
export const getUserByNameQueryKey = (username: GetUserByNamePathParams["username"]) => ["v5", { url: "/user/:username", params: { username: username } }] as const;
...
export const getUserByNameSuspenseQueryKey = (username: GetUserByNamePathParams["username"]) => ["v5", { url: "/user/:username", params: { username: username } }] as const;
