...
export const getOrderByIdQueryKey = (orderId: GetOrderByIdPathParams["orderId"]) => ["v5", { url: "/store/order/:orderId", params: { orderId: orderId } }] as const;
...
export const getOrderByIdSuspenseQueryKey = (orderId: GetOrderByIdPathParams["orderId"]) => ["v5", { url: "/store/order/:orderId", params: { orderId: orderId } }] as const;
