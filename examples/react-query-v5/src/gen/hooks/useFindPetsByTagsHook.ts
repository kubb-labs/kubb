...
export const findPetsByTagsInfiniteQueryKey = (params?: FindPetsByTags["queryParams"]) => ["v5", { url: "/pet/findByTags" }, ...(params ? [params] : [])] as const;
...
export const findPetsByTagsSuspenseQueryKey = (params?: FindPetsByTags["queryParams"]) => ["v5", { url: "/pet/findByTags" }, ...(params ? [params] : [])] as const;
