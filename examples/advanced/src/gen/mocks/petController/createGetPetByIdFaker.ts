...
export function createGetPetByIdPathParamsFaker(data?: Partial<GetPetByIdPathParams>): Partial<GetPetByIdPathParams> {
  return {
...
export function createGetPetByIdQueryResponseFaker(data?: Partial<GetPetByIdQueryResponse>): Partial<GetPetByIdQueryResponse> {
