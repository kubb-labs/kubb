 ...
 */
export function createTransferCancellationReasonFaker() {
  return faker.helpers.arrayElement<TransferCancellationReason>(['USER_CANCELLED', 'INSUFFICIENT_FUNDS', 'APPROVAL_DENIED', 'BLOCKED_BY_POSITIVE_PAY'])
}
