import type { CreatePetsPathParams, CreatePetsQueryParams, CreatePetsHeaderParams, CreatePetsMutationRequest, CreatePetsMutationResponse } from "../../models/ts/petsController/CreatePets.ts";
