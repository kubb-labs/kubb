...
import { findPetsByStatusResponseDataSchema } from '../../../zod/petController/findPetsByStatusSchema.ts'
...
export async function findPetsByStatus(
  ...
  return { ...res, data: findPetsByStatusResponseDataSchema.parse(res.data) }
}
