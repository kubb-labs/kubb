 ...
 * {@link /user/login}
 */
export function useLoginUser<TData = ResponseConfig<LoginUserQueryResponse>, TQueryData = ResponseConfig<LoginUserQueryResponse>, TQueryKey extends QueryKey = LoginUserQueryKey>({ params }: { params?: LoginUserQueryParams }, options: 
{
  query?: Partial<QueryObserverOptions<ResponseConfig<LoginUserQueryResponse>, ResponseErrorConfig<LoginUser400>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },
