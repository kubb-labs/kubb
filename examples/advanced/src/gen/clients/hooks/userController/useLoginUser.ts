...
export function loginUserQueryOptions({ params }: { params?: LoginUserQueryParams }, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  return queryOptions<ResponseConfig<LoginUserResponseData>, ResponseErrorConfig<LoginUserStatus400>, ResponseConfig<LoginUserResponseData>, typeof queryKey>({
    queryKey,
...
export function useLoginUser<
  TData = ResponseConfig<LoginUserResponseData>,
  TQueryData = ResponseConfig<LoginUserResponseData>,
  TQueryKey extends QueryKey = LoginUserQueryKey,
>(
  { params }: { params?: LoginUserQueryParams },
  options: {
    query?: Partial<QueryObserverOptions<ResponseConfig<LoginUserResponseData>, ResponseErrorConfig<LoginUserStatus400>, TData, TQueryData, TQueryKey>> & {
      client?: QueryClient
    }
