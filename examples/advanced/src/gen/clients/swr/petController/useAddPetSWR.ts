 ...
 * {@link /pet}
 */
export function useAddPetSWR(options: 
{
  mutation?: Parameters<typeof useSWRMutation<ResponseConfig<AddPetMutationResponse>, ResponseErrorConfig<AddPet405>, AddPetMutationKeySWR, AddPetMutationRequest>>[2],
