...
export function findPetsByTagsQueryOptionsSWR({ headers, params }: { headers: FindPetsByTagsHeaderParams; params?: FindPetsByTagsQueryParams }, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  return {
    fetcher: async () => {
 ...
 * {@link /pet/findByTags}
 */
export function useFindPetsByTagsSWR({ headers, params }: { headers: FindPetsByTagsHeaderParams; params?: FindPetsByTagsQueryParams }, options: 
{
