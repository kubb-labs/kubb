 ...
 */
export function useUploadFileSWR({ petId }: { petId: UploadFilePathParams["petId"] }, params?: UploadFileQueryParams, options: 
{
  mutation?: Parameters<typeof useSWRMutation<ResponseConfig<UploadFileMutationResponse>, ResponseErrorConfig<Error>, UploadFileMutationKeySWR, UploadFileMutationRequest>>[2],
