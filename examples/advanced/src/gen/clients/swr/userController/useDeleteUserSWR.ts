 ...
 * {@link /user/:username}
 */
export function useDeleteUserSWR({ username }: { username: DeleteUserPathParams["username"] }, options: 
{
  mutation?: Parameters<typeof useSWRMutation<ResponseConfig<DeleteUserMutationResponse>, ResponseErrorConfig<DeleteUser400 | DeleteUser404>, DeleteUserMutationKeySWR>>[2],
