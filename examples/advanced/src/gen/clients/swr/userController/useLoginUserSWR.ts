 ...
 * {@link /user/login}
 */
export function useLoginUserSWR({ params }: { params?: LoginUserQueryParams }, options: 
{
 ...
 = {}) {
  ...
  return useSWR<ResponseConfig<LoginUserQueryResponse>, ResponseErrorConfig<LoginUser400>, LoginUserQueryKeySWR | null>(
