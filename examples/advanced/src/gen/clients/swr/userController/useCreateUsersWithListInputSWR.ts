 ...
 */
export function useCreateUsersWithListInputSWR(options: 
{
  mutation?: Parameters<typeof useSWRMutation<ResponseConfig<CreateUsersWithListInputMutationResponse>, ResponseErrorConfig<Error>, CreateUsersWithListInputMutationKeySWR, CreateUsersWithListInputMutationRequest>>[2],
 ...
 = {}) {
  ...
  return useSWRMutation<ResponseConfig<CreateUsersWithListInputMutationResponse>, ResponseErrorConfig<Error>, CreateUsersWithListInputMutationKeySWR | null, CreateUsersWithListInputMutationRequest>(
