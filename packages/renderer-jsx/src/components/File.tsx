...
type Props<TMeta> = BaseProps & {
   ...
   * one. Use to emit a real source file shipped inside a package (a template) into the generated
   * folder. Child source blocks are ignored for output but still drive barrel generation.
   */
  copy?: string | null
  /**
