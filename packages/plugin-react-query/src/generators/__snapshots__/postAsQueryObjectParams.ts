...
export const updatePetWithFormQueryKey = (
  { petId }: { petId: UpdatePetWithFormPathParams['petId'] | undefined },
...
export function updatePetWithFormQueryOptions(
  {
    ...
    data,
    params,
  }: { petId: UpdatePetWithFormPathParams['petId'] | undefined; data?: UpdatePetWithFormMutationRequest; params?: UpdatePetWithFormQueryParams },
  config: Partial<RequestConfig<UpdatePetWithFormMutationRequest>> & { client?: Client } = {},
) {
  ...
  return queryOptions<UpdatePetWithFormMutationResponse, ResponseErrorConfig<UpdatePetWithForm405>, UpdatePetWithFormMutationResponse, typeof queryKey>({
    ...
    queryFn: async ({ signal }) => {
      return updatePetWithForm({ petId: petId!, data: data, params: params }, { ...config, signal: config.signal ?? signal })
    },
  })
}
...
>(
  ...
  const queryKey = resolvedOptions?.queryKey ?? updatePetWithFormQueryKey({ petId }, data, params)
