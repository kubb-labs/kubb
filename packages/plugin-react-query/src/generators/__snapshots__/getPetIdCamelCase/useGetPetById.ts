...
export function getPetByIdQueryOptions(petId: GetPetByIdPathParams['petId'], config: Partial<RequestConfig> & { client?: Client } = {}) {
  ...
  return queryOptions<GetPetByIdQueryResponse, ResponseErrorConfig<GetPetById400>, GetPetByIdQueryResponse, typeof queryKey>({
    enabled: !!petId,
    queryKey,
...
export function useGetPetById<TData = GetPetByIdQueryResponse, TQueryData = GetPetByIdQueryResponse, TQueryKey extends QueryKey = GetPetByIdQueryKey>(
  ...
  options: {
    query?: Partial<QueryObserverOptions<GetPetByIdQueryResponse, ResponseErrorConfig<GetPetById400>, TData, TQueryData, TQueryKey>> & { client?: QueryClient }
  ...
  const query = useQuery(
    ...
    queryClient,
  ) as UseQueryResult<TData, ResponseErrorConfig<GetPetById400>> & { queryKey: TQueryKey }
