import { createFunctionParameter, createFunctionParameters, createParameterGroup, createTypeExpressionNode } from '@kubb/ast'
...
describe('functionPrinter in declaration mode', () => {
  ...
  it('prints required typed parameters as `name: type`', () => {
    const sig = createFunctionParameters({
      params: [createFunctionParameter({ name: 'petId', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false })],
    })
  ...
  it('prints optional typed parameters as `name?: type`', () => {
    const sig = createFunctionParameters({
      params: [createFunctionParameter({ name: 'params', type: createTypeExpressionNode({ variant: 'reference', name: 'QueryParams' }), optional: true })],
    })
  ...
  it('prints defaulted typed parameters as `name: type = default`', () => {
    const sig = createFunctionParameters({
      params: [
        createFunctionParameter({ name: 'config', type: createTypeExpressionNode({ variant: 'reference', name: 'RequestConfig' }), optional: false, default: '{}' }),
      ],
    })
  ...
  it('prints rest parameters with spread syntax', () => {
    const sig = createFunctionParameters({
      params: [createFunctionParameter({ name: 'args', type: createTypeExpressionNode({ variant: 'reference', name: 'string[]' }), optional: false, rest: true })],
    })
  ...
  it('orders parameters as required, optional, then defaulted', () => {
    const sig = createFunctionParameters({
      params: [
        createFunctionParameter({ name: 'config', type: createTypeExpressionNode({ variant: 'reference', name: 'Config' }), optional: false, default: '{}' }),
        createFunctionParameter({ name: 'params', type: createTypeExpressionNode({ variant: 'reference', name: 'Params' }), optional: true }),
        createFunctionParameter({ name: 'petId', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false }),
      ],
    })
  ...
  it('always places rest parameters last', () => {
    const sig = createFunctionParameters({
      params: [
        createFunctionParameter({ name: 'args', type: createTypeExpressionNode({ variant: 'reference', name: 'string[]' }), rest: true }),
        createFunctionParameter({ name: 'petId', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false }),
      ],
    })
    ...
    const sig = createFunctionParameters({
      params: [
        createParameterGroup({
          properties: [
            createFunctionParameter({ name: 'id', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false }),
            createFunctionParameter({ name: 'name', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: true }),
          ],
          default: '{}',
        }),
      ],
    ...
    const sig = createFunctionParameters({
      params: [
        createParameterGroup({
          ...
          type: createTypeExpressionNode({ variant: 'reference', name: 'PetData' }),
          default: '{}',
        }),
      ],
    })
    ...
    const sig = createFunctionParameters({
      params: [
        createParameterGroup({
          properties: [
            createFunctionParameter({ name: 'petId', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false }),
            createFunctionParameter({ name: 'ownerId', type: createTypeExpressionNode({ variant: 'reference', name: 'number' }), optional: false }),
          ],
          inline: true,
        }),
      ],
...
describe('functionPrinter() in keys mode', () => {
  ...
  it('prints comma-separated parameter names', () => {
    const sig = createFunctionParameters({
      params: [
        createFunctionParameter({ name: 'petId', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false }),
        createFunctionParameter({ name: 'config', type: createTypeExpressionNode({ variant: 'reference', name: 'Config' }), optional: false }),
      ],
    })
  ...
  it.each([
    {
      ...
      param: createFunctionParameter({ name: 'petId', type: createTypeExpressionNode({ variant: 'reference', name: 'string' }), optional: false }),
      expected: 'PETID: string',
    },
    {
      label: 'transformType',
      options: { mode: 'declaration' as const, transformType: (t: string) => `Partial<${t}>` },
      param: createFunctionParameter({ name: 'config', type: createTypeExpressionNode({ variant: 'reference', name: 'Config' }), optional: false }),
