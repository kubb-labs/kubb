...
export const typeGenerator = createReactGenerator<PluginTs>({
  ...
  Operation({ operation, generator, plugin }) {
    const {
      options,
      options: { mapper, enumType, enumKeyCasing, syntaxType, optionalType, arrayType, propertyCasing, unknownType },
    } = plugin
  ...
  Schema({ schema, plugin }) {
    const {
      options: { mapper, enumType, enumKeyCasing, syntaxType, optionalType, arrayType, propertyCasing, output },
    } = plugin
    const mode = useMode()
