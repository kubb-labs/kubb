...
describe('uniqueName', () => {
  describe('getUniqueName', () => {
    test('should return original name for first occurrence', () => {
    ...
    test('should append number for duplicate names', () => {
    ...
    test('should handle different names independently', () => {
      const data: Record<string, number> = {}
  ...
  describe('setUniqueName', () => {
    ...
    test('should return original name even for duplicates', () => {
      const data: Record<string, number> = { test: 1 }
      const result = setUniqueName('test', data)
      expect(result).toBe('test')
    ...
    test('should increment counter for each call', () => {
      const data: Record<string, number> = {}
