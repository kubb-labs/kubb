...
import type { Config, GeneratorContext, KubbBuildEndContext, KubbBuildStartContext, KubbPluginSetupContext, Plugin } from './types'
...
export interface KubbHooks {
  ...
  /**
   * Fired once — before any plugin's setup runs — so that hook-style plugins
