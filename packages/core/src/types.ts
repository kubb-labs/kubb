...
export type GetPluginFactoryOptions<TPlugin extends UserPlugin> =
  TPlugin extends UserPlugin<infer X> ? X : never;
...
> = {
  ...
  inject?: (
    ...
    context: PluginContext<TOptions>,
  ) => TOptions["context"];
};

export type UserPluginWithLifeCycle<
  TOptions extends PluginFactoryOptions = PluginFactoryOptions,
> = UserPlugin<TOptions> & PluginLifecycle<TOptions>;

type UnknownUserPlugin = UserPlugin<
  PluginFactoryOptions<any, any, any, any, any>
>;
...
export type PluginWithLifeCycle<
  TOptions extends PluginFactoryOptions = PluginFactoryOptions,
> = Plugin<TOptions> & PluginLifecycle<TOptions>;
...
export type PluginParameter<H extends PluginLifecycleHooks> = Parameters<
  Required<PluginLifecycle>[H]
>;
...
export type UserLogger<TOptions extends LoggerOptions = LoggerOptions> = Omit<
  Logger<TOptions>,
  "logLevel"
>;
