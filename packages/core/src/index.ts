...
export { DiagnosticError, diagnosticDocsUrl, Diagnostics } from './diagnostics.ts'
export type { Diagnostic, DiagnosticKind, DiagnosticLocation, DiagnosticSeverity, SerializedDiagnostic } from './diagnostics.ts'
