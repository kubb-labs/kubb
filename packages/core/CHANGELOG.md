...
- Updated dependencies [[`7007a5f`](https://github.com/kubb-labs/kubb/commit/7007a5f74b64f0e0398d7363d7f3aa3724d0f9b1)]:
...
- [#3135](https://github.com/kubb-labs/kubb/pull/3135) [`fd014c6`](https://github.com/kubb-labs/kubb/commit/fd014c6870ae4eefbe5ea8fac32ab9ba226defa9) Thanks [@copilot-swe-agent](https://github.com/apps/copilot-swe-agent)! - Add `Middleware` type, `defineMiddleware` factory, and `middleware` array to `Config`.
...
- [#3143](https://github.com/kubb-labs/kubb/pull/3143) [`535a2db`](https://github.com/kubb-labs/kubb/commit/535a2db4acbe2f37966190c1330d76f541afed00) Thanks [@copilot-swe-agent](https://github.com/apps/copilot-swe-agent)! - Add `enforce: 'pre' | 'post'` plugin ordering.
...
- [#3133](https://github.com/kubb-labs/kubb/pull/3133) [`8d7cec1`](https://github.com/kubb-labs/kubb/commit/8d7cec1bf37e74dfdc6c03f61582b619284132c2) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - Remove unused `TContext` and `TResolvePathOptions` generics from `PluginFactoryOptions`.
...
- [#64](https://github.com/tigawanna/kubb/pull/64) [`f7d19bb`](https://github.com/kubb-labs/kubb/commit/f7d19bb69177fbd1b54c855423b3b55c399678b0) Thanks [@pull](https://github.com/apps/pull)! - `getMode` is now a static method on `PluginDriver` instead of a standalone export.
...
- [#3068](https://github.com/kubb-labs/kubb/pull/3068) [`c8a1efb`](https://github.com/kubb-labs/kubb/commit/c8a1efb4e71d475eb383a93ebf02da9afda33f79) Thanks [@copilot-swe-agent](https://github.com/apps/copilot-swe-agent)! - Expose an `ast` namespace const from `@kubb/core` that re-exports every runtime helper from `@kubb/ast`. Community plugins can now import `{ ast }` from `@kubb/core` instead of depending on `@kubb/ast` directly. All AST types are also re-exported from `@kubb/core`.
...
- Updated dependencies [[`9e6a772`](https://github.com/kubb-labs/kubb/commit/9e6a772c7ca1ee54e931d2dbf0f2448f67707c0e)]:
...
- [`945f689`](https://github.com/kubb-labs/kubb/commit/945f689c64371fa06aaa5772974420d712f17619) Thanks [@stijnvanhullem](https://github.com/stijnvanhullem)! - fixed version for Fabric
