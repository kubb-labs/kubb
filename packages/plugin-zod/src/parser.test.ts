...
describe('zod parse', () => {
  ...
  describe('coercion with version 4', () => {
    test('uuid with coercion=true and version=4 should use z.coerce.string().uuid()', () => {
    ...
    test('url with coercion=true and version=4 should use z.coerce.string().url()', () => {
    ...
    test('email with coercion=true and version=4 should use z.coerce.string().email()', () => {
