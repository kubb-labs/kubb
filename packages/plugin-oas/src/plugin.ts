...
import { type Config, definePlugin, type Group, type KubbEvents, registerNameResolver, registerPathResolver } from '@kubb/core'
...
registerNameResolver(pluginOasName, (name, type) => {
  return camelCase(name, { isFile: type === 'file' })
})

// Register path resolver with core
registerPathResolver(pluginOasName, (baseName, mode, options, ctx) => {
  if (mode === 'single') {
