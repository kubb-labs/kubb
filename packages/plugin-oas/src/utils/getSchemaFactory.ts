 ...
 */
export function getSchemaFactory<TWithRef extends boolean = false>(oas: Oas): (schema: OpenAPIV3_1.SchemaObject | null) => SchemaResult<TWithRef> {
  return (schema: OpenAPIV3_1.SchemaObject | null) => {
