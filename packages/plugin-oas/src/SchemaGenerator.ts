...
> extends BaseGenerator<TOptions, Context<TOptions, TPluginOptions>> {
  ...
  #parseSchemaObject({ schemaObject: _schemaObject, name, parentName }: SchemaProps): Schema[] {
    ...
    if (schemaObject.minItems !== undefined || schemaObject.maxItems !== undefined) {
      return [{ keyword: schemaKeywords.array, args: { items: [], min: undefined, max: undefined, unique: false } }, ...baseItems]
    }
