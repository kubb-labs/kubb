...
// The default `mode: 'split'` shape: one small file, a few imports, createFile called once each.
...
// The consolidated shape: one file absorbing N fragments, createFile re-running on every merge.
function merged(n) {
