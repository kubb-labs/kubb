...
import { createFunctionParameter, createOperation, createParameter, createSchema, createTypeExpressionNode } from './factory.ts'
  ...
  describe('object mode', () => {
    it('wraps all params into a single destructured object', () => {
      ...
      const params = createOperationParams(node, {
        ...
        extraParams: [createFunctionParameter({ name: 'options', type: createTypeExpressionNode({ variant: 'reference', name: 'Options' }), default: '{}' })],
      })
