...
describe('definePrinter', () => {
  it('exposes the given name and resolved options', () => {
    type P = PrinterFactoryOptions<'zod', { strict?: boolean }, { strict: boolean }, string>
  ...
  it('print returns undefined when no node handler matches', () => {
    type P = PrinterFactoryOptions<'zod', object, object, string>
  ...
  it('handler accesses resolved options via this.options', () => {
    type P = PrinterFactoryOptions<'zod', { prefix?: string }, { prefix: string }, string>
