...
- [#3191](https://github.com/kubb-labs/kubb/pull/3191) [`a390935`](https://github.com/kubb-labs/kubb/commit/a3909357370290f9ad5b4c40ce77aa94599856a5) Thanks [@DesselBane](https://github.com/DesselBane)! - Fix infinite recursion for mutually recursive schemas in `plugin-faker`.
  ...
  **Fixed**: Cyclic properties are now emitted as JavaScript getter properties. The outer object spread (`{ ...inner }`) still materialises all getters, so faker's deterministic seed behaviour is preserved by default.
  ...
  export function cat(data?: Partial<Cat>): Cat {
    return {
      ...{
        id: faker.number.int(),
        __typename: faker.helpers.arrayElement<NonNullable<Cat>["__typename"]>([
          "Cat",
        ]),
        get archEnemy() {
