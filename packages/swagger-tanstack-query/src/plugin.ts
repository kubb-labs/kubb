...
import { camelCase, merge, pascalCase } from "@kubb/core/transformers";
...
import type { Mutate, PluginOptions } from "./types.ts";

export const pluginName =
  "swagger-tanstack-query" satisfies PluginOptions["name"];
  ...
  return {
    ...
    options: {
      ...
      infinite: infinite
        ...
        : false,
      suspense: merge({}, suspense),
      query: merge(
        {
          queryKey: (key: string) => key,
          methods: ["get"],
        },
        query,
      ),
