...
export const UpdatePetWithFormQueryKey = ({ petId }: UpdatePetWithFormPathParams, params?: UpdatePetWithForm['queryParams']) =>
  [{ url: '/pet/:petId', params: { petId: petId } }, ...(params ? [params] : [])] as const
export type UpdatePetWithFormQueryKey = ReturnType<typeof UpdatePetWithFormQueryKey>
export function UpdatePetWithFormQueryOptions<TData = UpdatePetWithForm['response'], TQueryData = UpdatePetWithForm['response']>(
  { petId }: UpdatePetWithFormPathParams,
  params?: UpdatePetWithForm['queryParams'],
  options: UpdatePetWithForm['client']['parameters'] = {},
): WithRequired<UseBaseQueryOptions<UpdatePetWithForm['response'], UpdatePetWithForm['error'], TData, TQueryData>, 'queryKey'> {
