 ...
 */
export const KUBB_NPM_PACKAGE_URL =
  "https://registry.npmjs.org/@kubb/cli/latest" as const;
 ...
 */
export const QUITE_FLAGS = new Set([
  "--help",
  "-h",
  "--version",
  "-v",
 ...
 */
export const GENERATE_FLAGS = new Set([
  "--config",
  "-c",
  "--log-level",
  "-l",
 ...
 */
export const AGENT_START_FLAGS = new Set([
  "--config",
  "-c",
  "--port",
  "-p",
