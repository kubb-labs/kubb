...
describe('applyDiscriminatorInheritance', () => {
  ...
  it('injects the discriminator enum into child object schemas', async () => {
    ...
    expect(toSnapshot(narrowSchema(dog, 'object'))).toMatchInlineSnapshot(`
      {
        "kind": "Schema",
        "name": "Dog",
        "primitive": "object",
    ...
    expect(toSnapshot(narrowSchema(cat, 'object'))).toMatchInlineSnapshot(`
      {
        "kind": "Schema",
        "name": "Cat",
        "primitive": "object",
  ...
  it('leaves child schemas not in the discriminator mapping untouched', async () => {
    ...
    expect(toSnapshot(narrowSchema(unrelated, 'object'))).toMatchInlineSnapshot(`
      {
        "kind": "Schema",
