 ...
 * ```
 */
export const HttpMethods = Object.fromEntries(
  Object.entries(ast.httpMethods).map(([lower, upper]) => [upper, lower]),
) as Record<Uppercase<ast.HttpMethod>, Lowercase<ast.HttpMethod>>;
 ...
 */
export type AdapterOas = AdapterFactoryOptions<
  "oas",
  AdapterOasOptions,
