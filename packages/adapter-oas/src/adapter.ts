...
import { buildDiscriminatorChildMap, patchDiscriminatorNode } from './emit/discriminator/index.ts'
import type { DiscriminatorTarget } from './emit/discriminator/index.ts'
import { assertInputExists, parseDocument, parseFromConfig, validateDocument } from './load/index.ts'
