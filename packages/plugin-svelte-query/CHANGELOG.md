...
- [#3072](https://github.com/kubb-labs/kubb/pull/3072) [`9ba2ac3`](https://github.com/kubb-labs/kubb/commit/9ba2ac3e67475ef251f92608357837c6fa864405) Thanks [@DesselBane](https://github.com/DesselBane)! - Fix TypeScript contradiction where required path params in `queryOptions`/`queryKey` signatures prevented callers from passing `undefined` to conditionally disable a query.
...
- [#1216](https://github.com/kubb-labs/kubb/pull/1216) [`ef53216`](https://github.com/kubb-labs/kubb/commit/ef532164ad94f04d7e1a0cc4edc841f2fb0a122b) Thanks [@stijnvanhulle](https://github.com/stijnvanhulle)! - svelte-query v3
