...
import type { Equal, HasNoErrors, Head, Head2, ParserError, Tail, TailBy } from './utils.ts'
 ...
 */
type ParseIdentifiers<Tokens extends ASTs[], UsedTokens extends ASTs[], Res extends Parsers[] = [], Cursor = Head<Tokens>> = Cursor extends []
  ? Res extends []
    ? Res
    : Res
  : HasNoErrors<SelectToken<Tokens[4], 'LINEBREAK'> | SelectToken<Tokens[5], 'INDENT'>> extends true
  ? ParseIdentifiers<TailBy<Tokens, 6>, UsedTokens, [...Res, ParserInternal<TailBy<Tokens, 6>, [...UsedTokens, TailBy<Tokens, 6>]>], Head<TailBy<Tokens, 6>>>
  : Res

type ParseRootIdentifier<
  Tokens extends ASTs[],
  UsedTokens extends ASTs[],
  Res extends Parsers,
...
> = LookBack extends {
  ...
  ? // Tag:\n
    //TODO get all tokens that have the same indent and return ParserInternal with res set to ...
    Debug<
      {
        type: 'RootIdentifier'
        debug: {
        ...
        children: [
          ...
          ParserInternal<[...Tokens], UsedTokens>,
          ...ParseIdentifiers<Tokens, UsedTokens>,
...
> = IsToken<Cursor, 'LINEBREAK' | 'COLLON'> extends true // skip linebreak and collon
  ? ParserInternal<TailBy<Tokens, 1>, [...UsedTokens, Head<Tokens>], Res, Head<Tokens>>
  ...
  ? Res extends {
    ...
    ? ParseRootIdentifier<TailBy<Tokens, 1>, [...UsedTokens, Head<Tokens>], Res, LookBack, Head<TailBy<Tokens, 1>>, Head2<TailBy<Tokens, 1>>>
    : never
  : Res

//ParserError<`Expected token of type IDENT, got ${LookAhead['type']}`>
export type Parser<Tokens extends ASTs[], UsedTokens extends ASTs[] = []> = ParserInternal<Tokens, UsedTokens>
...
type Parser3 = Parser<Token3>
type ParseIdentifiersDemo = Parser<
  [
    Identifier<'properties', never>,
    Collon,
    LineBreak<1>,
    Indent<2>,
    Identifier<'id', 2>,
