...
export type Options = {
  ...
  /**
   * Group the Pinia Colada hooks based on the provided name.
   */
  group?: Group
  ...
  /**
   * Which parser should be used before returning the data to Pinia Colada.
  ...
  /**
   * Define some generators next to the pinia-colada generators
   */
  generators?: Array<Generator<PluginPiniaColada>>
}

type ResolvedOptions = {
  output: Output<Oas>
  group: Options['group']
  client: NonNullable<PluginPiniaColada['options']['client']>
...
export type PluginPiniaColada = PluginFactoryOptions<'plugin-pinia-colada', Options, ResolvedOptions, never, ResolvePathOptions>
