...
export const pluginPiniaColadaName = 'plugin-pinia-colada' satisfies PluginPiniaColada['name']

export const pluginPiniaColada = definePlugin<PluginPiniaColada>((options) => {
  const {
