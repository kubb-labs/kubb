...
import { Query, QueryKey } from '../components'
import type { PluginPiniaColada } from '../types'

export const queryGenerator = createReactGenerator<PluginPiniaColada>({
  name: 'pinia-colada',
  Operation({ config, operation, generator, plugin }) {
    ...
    const importPath = options.query ? options.query.importPath : '@pinia/colada'
      ...
      >
        ...
        {options.query && (
          <>
            ...
            <File.Import name={['QueryKey', 'UseQueryOptions', 'UseQueryReturnType']} path={importPath} isTypeOnly />
            <Query
              name={query.name}
