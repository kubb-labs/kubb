declare module "openapi-format" {
  interface Options {
    ...
    filterSet?: {
      ...
      unusedComponents?: Array<
        "requestBodies" | "schemas" | "parameters" | "responses"
      >;
    };
    sortComponentsSet?: {};
    casingSet?: {};
  ...
  function openapiFilter<TOas>(
    document: TOas,
    options: Options,
  ): { data: Toas; resultData: { unusedComp: any } };

  function openapiSort<TOas>(
    document: TOas,
    options: Options,
  ): { data: Toas; resultData: { unusedComp: any } };
  function openapiChangeCase<TOas>(
    document: TOas,
    options: Options,
  ): { data: Toas; resultData: { unusedComp: any } };
