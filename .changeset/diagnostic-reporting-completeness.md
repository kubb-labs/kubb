...
- New codes `KUBB_UNSUPPORTED_FORMAT` (warning) and `KUBB_DEPRECATED` (info), emitted by the OAS adapter; the renderer, counts, and json report handle every severity.
