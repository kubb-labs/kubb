...
`@kubb/ast` gains the spec-agnostic primitives that power this: `signatureOf` (a content hash of a schema's shape), `isSchemaEqual`, `buildDedupePlan`, and `applyDedupe`.
