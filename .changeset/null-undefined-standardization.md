...
Standardize `null` vs `undefined` across the codebase. Kubb-controlled "absent" or "skip" states now use `null` explicitly, and `undefined` is reserved for optional TypeScript properties and external or user-supplied values.
